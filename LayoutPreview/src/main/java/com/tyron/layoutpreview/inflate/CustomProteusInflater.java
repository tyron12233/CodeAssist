...
import com.flipkart.android.proteus.IdGenerator;
...
/**
 * Custom ProteusLayoutInflater based on {@link com.flipkart.android.proteus.SimpleLayoutInflater} that
 * returns unknown views instaead of throwing an exception
 */
public class CustomProteusInflater implements ProteusLayoutInflater {

    private static final String TAG = "CustomProteusInflater";
    ...
    CustomProteusInflater(@NonNull ProteusContext context, @NonNull IdGenerator idGenerator) {

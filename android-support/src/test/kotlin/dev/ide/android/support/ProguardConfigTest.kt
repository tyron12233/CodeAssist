...
class ProguardConfigTest {
    ...
    @Test
    fun extractsBundledDefaultsFromAssets() = withTempDir("pg-defaults") { dir ->
    ...
    @Test
    fun resolvesDefaultsAndModuleRelativeFilesAndSkipsMissing() = withTempDir("pg-module") { module ->

...
public class LambdaToMethod extends TreeTranslator {
    ...
    class LambdaAnalyzerPreprocessor extends TreeTranslator {
         ...
         */
        public abstract class TranslationContext<T extends JCFunctionalExpression> {
         ...
         */
        public class LambdaTranslationContext extends TranslationContext<JCLambda> {
         ...
         */
        public final class ReferenceTranslationContext extends TranslationContext<JCMemberReference> {

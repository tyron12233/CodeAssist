    ...
    private class BootClassPathLocationHandler extends LocationHandler {
        ...
        Path computePath() {
            ...
            if (bootclasspathOpt != null) {
                ...
                String files = "/data/data/com.tyron.code/files/rt.jar:/data/data/com.tyron.code/core-lambda-stubs.jar"; //System.getProperty("sun.boot.class.path");
                path.addFiles(files, true);

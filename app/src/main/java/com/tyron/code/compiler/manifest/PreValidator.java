...
import static com.tyron.code.compiler.manifest.MergingReport.Record.Severity.ERROR;
import static com.tyron.code.compiler.manifest.MergingReport.Record.Severity.WARNING;
import static com.tyron.code.compiler.manifest.XmlNode.NodeKey;
...
import com.tyron.code.compiler.manifest.xml.AndroidManifest;
...
public class PreValidator {
    ...
    /**
     * Validates a loaded {@link com.tyron.code.compiler.manifest.XmlDocument} and return a status of the
     * merging model.
     *
     * Will return one the following status :
     * <ul>
     *     <li>{@link com.tyron.code.compiler.manifest.MergingReport.Result#SUCCESS} : the merging model is
     *     correct, merging should be attempted</li>
     *     <li>{@link com.tyron.code.compiler.manifest.MergingReport.Result#WARNING} : the merging model
     *     contains non fatal error, user should be notified, merging can be attempted</li>
     *     <li>{@link com.tyron.code.compiler.manifest.MergingReport.Result#ERROR} : the merging model
     ...
     * @return one the {@link com.tyron.code.compiler.manifest.MergingReport.Result} value.
     */
    @NonNull

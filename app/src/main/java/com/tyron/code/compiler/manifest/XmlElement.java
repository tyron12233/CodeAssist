...
public class XmlElement extends OrphanXmlElement {
    ...
    /**
     * Returns the owning {@link com.tyron.code.compiler.manifest.XmlDocument}
     */
    @NonNull
    ...
    /**
     * Returns the {@link com.tyron.code.compiler.manifest.XmlAttribute} for an attribute present on this
     ...
     * {@link com.tyron.code.compiler.manifest.NodeOperationType#MERGE} will be returned.
     */
     ...
     * <p>
     * <ul>
     *     <li>The associate {@link com.tyron.code.compiler.manifest.ManifestModel.NodeTypes} is
     *     annotated with {@link com.tyron.code.compiler.manifest.MergeType#IGNORE}</li>
     ...
     * the {@link com.tyron.code.compiler.manifest.SdkConstants#TOOLS_URI} namespace.
     *

...
public class Jvm implements JavaInfo {
    ...
    Jvm(OperatingSystem os) {
        this(os, GFileUtils.canonicalize(new File(System.getProperty("java.home"))), System.getProperty("java.version"), JavaVersion.current(), false);
    }
     ...
     * @throws com.tyron.builder.internal.jvm.JavaHomeException when supplied javaHome does not seem to be a valid jdk or jre location

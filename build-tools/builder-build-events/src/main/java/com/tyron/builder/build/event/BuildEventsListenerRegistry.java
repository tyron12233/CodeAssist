...
package com.tyron.builder.build.event;
...
public interface BuildEventsListenerRegistry {
    /**
     * Subscribes the given listener to the finish events for tasks, if not already subscribed. The listener receives a {@link com.tyron.builder.tooling.events.task.TaskFinishEvent} as each task completes.
     *
     ...
     *
     * @param listener The listener to receive events. This must be a {@link com.tyron.builder.api.services.BuildService} instance, see {@link com.tyron.builder.api.services.BuildServiceRegistry}.
     */

 ...
 * Read more about declaring artifacts in the configuration in docs for {@link com.tyron.builder.api.artifacts.dsl.ArtifactHandler}
 *
...
public interface Configuration extends FileCollection, HasConfigurableAttributes<Configuration> {
     ...
     *
     * @see com.tyron.builder.api.artifacts.Configuration.State
    ...
    /**
     * A {@link com.tyron.builder.api.Namer} namer for configurations that returns {@link #getName()}.
     */
    class Namer implements com.tyron.builder.api.Namer<Configuration> {
        @Override
     ...
     * {@link #files(com.tyron.builder.api.specs.Spec)}.
     *
    ...
    /**
     * Takes a closure which gets coerced into a {@link Spec}. Behaves otherwise in the same way as
     * {@link #fileCollection(com.tyron.builder.api.specs.Spec)}.
     *
     * @param dependencySpecClosure The closure describing a filter applied to the all the dependencies of this configuration (including dependencies from extended configurations).
     * @return The FileCollection with a subset of dependencies of this configuration.
     */
     ...
     * @see com.tyron.builder.api.tasks.Upload
     */
    @Deprecated
     ...
     *      dependencies.add(owner.project.dependencies.create("com.tyron.builder:my-util:1.0"))
     * }
     * </pre>
     *
    ...
    /**
     * Takes a closure which gets coerced into a {@link Spec}. Behaves otherwise in the same way as {@link #copy(com.tyron.builder.api.specs.Spec)}
     *
     * @param dependencySpec filtering requirements
     * @return copy of this configuration
     */
    ...
    /**
     * Takes a closure which gets coerced into a {@link Spec}. Behaves otherwise in the same way as {@link #copyRecursive(com.tyron.builder.api.specs.Spec)}
     *
     * @param dependencySpec filtering requirements
     * @return copy of this configuration
     */

...
public interface ResolutionStrategy {
     ...
     * <ul>
     *   <li>String in a format of: 'group:name:version', for example: 'com.tyron.builder:gradle-core:1.0'</li>
     ...
     *       //specifying a fixed version for all libraries with 'com.tyron.builder' group
     *       if (details.requested.group == 'com.tyron.builder') {

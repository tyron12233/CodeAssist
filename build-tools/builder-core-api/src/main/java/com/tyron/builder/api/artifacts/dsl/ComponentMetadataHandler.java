...
public interface ComponentMetadataHandler {
     ...
     * <ul>
     *     <li>{@link com.tyron.builder.api.artifacts.ivy.IvyModuleDescriptor} - additional Ivy-specific
     *     metadata. Rules declaring this parameter will only be invoked for components packaged as an Ivy module.</li>
     *     <li>{@link com.tyron.builder.api.artifacts.maven.PomModuleDescriptor} - additional Maven-specific
     ...
     *
     * <p>The ruleSource is an Object that has a single rule method annotated with {@link com.tyron.builder.model.Mutate}.
     *
     * <p>This rule method:
     * <ul>
     *     <li>must return void.</li>
     *     <li>must have {@link ComponentMetadataDetails} as the first parameter.</li>
     *     <li>may have an additional parameter of type {@link com.tyron.builder.api.artifacts.ivy.IvyModuleDescriptor} or {@link com.tyron.builder.api.artifacts.maven.PomModuleDescriptor}.</li>
     * </ul>
     *

 ...
 * configurations (see {@link com.tyron.builder.api.artifacts.Configuration}).</p>
 *
 ...
 *      docs for {@link com.tyron.builder.api.artifacts.ModuleDependency#exclude(java.util.Map)}.</li>
 ...
 *   <li>Explicit specification of the artifact. See also {@link com.tyron.builder.api.artifacts.ModuleDependency#artifact(groovy.lang.Closure)}.</li>
 * </ul>
 *
 * <pre class='autoTested'>
 * plugins {
 ...
 * {@link com.tyron.builder.api.artifacts.Dependency} directly:</p>
 *
 * <code><i>configurationName</i> &lt;instance&gt;</code>
 *
 * <p>Dependencies can also be declared with a {@link com.tyron.builder.api.provider.Provider} that provides any of the other supported dependency notations.</p>
 *
 ...
 * com.tyron.builder.api.artifacts.ExternalModuleDependency}.</p>
 *
 * <pre class='autoTested'>
 * plugins {
 *     id 'java' // so that we can use 'implementation', 'testImplementation' for dependencies
 ...
 *
 * <p>Project dependencies are represented using a {@link com.tyron.builder.api.artifacts.ProjectDependency}.
 *
 * <h3>File dependencies</h3>
 *
 * <p>You can also add a dependency using a {@link com.tyron.builder.api.file.FileCollection}:</p>
 ...
 * </pre>
 *
 * <p>File dependencies are represented using a {@link com.tyron.builder.api.artifacts.SelfResolvingDependency}.</p>
 *
 * <h3>Dependencies to other configurations</h3>
 *
 * <p>You can add a dependency using a {@link com.tyron.builder.api.artifacts.Configuration}.</p>
 *
 ...
 * not available. Client modules are represented using a {@link com.tyron.builder.api.artifacts.ClientModule}.
 *
 */
public interface DependencyHandler extends ExtensionAware {
     ...
     *
     * <p>This method executes the given action against the {@link com.tyron.builder.api.artifacts.dsl.DependencyConstraintHandler} for this project.</p>
     *
     ...
     *
     * <p>This method executes the given action against the {@link com.tyron.builder.api.artifacts.dsl.ComponentMetadataHandler} for this project.</p>
     *
     * @param configureAction the action to use to configure module metadata
     * @since 1.8
     */
     ...
     *
     * <p>This method executes the given action against the {@link com.tyron.builder.api.artifacts.dsl.ComponentModuleMetadataHandler} for this project.
     *
     * @param configureAction the action to use to configure module metadata
     * @since 2.2
     */
     ...
     * @see com.tyron.builder.api.artifacts.transform.ArtifactTransform
     * @since 3.5
     */
    @Deprecated

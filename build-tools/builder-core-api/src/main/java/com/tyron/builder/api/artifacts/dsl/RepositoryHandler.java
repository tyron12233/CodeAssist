...
import com.tyron.builder.api.artifacts.repositories.ExclusiveContentRepository;
...
public interface RepositoryHandler extends ArtifactRepositoryContainer {
     ...
     *     <td>Specifies a list of rootDirs where to look for dependencies. These are evaluated as per {@link com.tyron.builder.api.BuildProject#files(Object...)}</td></tr>
     * </table>
     *
     * <p>Examples:</p>
     ...
     * @throws com.tyron.builder.api.InvalidUserDataException In the case neither rootDir nor rootDirs is specified of if both
     * are specified.
     */
     ...
     * The behavior of this repository is otherwise the same as those added by {@link #maven(com.tyron.builder.api.Action)}.
     * <p>
     * Examples:
     ...
     * {@value com.tyron.builder.api.artifacts.ArtifactRepositoryContainer#MAVEN_CENTRAL_URL}.
     *
     ...
     * {@value com.tyron.builder.api.artifacts.ArtifactRepositoryContainer#DEFAULT_MAVEN_CENTRAL_REPO_NAME} is used as the name. A name
     ...
     * The provided values are evaluated as per {@link com.tyron.builder.api.BuildProject#uri(Object)}.</td></tr>
     * </table>
     *
     * <p>Examples:</p>
     * <pre class='autoTested'>
    ...
    /**
     * Adds a repository which looks in the Maven central repository for dependencies. The URL used to access this repository is
     * {@value com.tyron.builder.api.artifacts.ArtifactRepositoryContainer#MAVEN_CENTRAL_URL}. The name of the repository is
     * {@value com.tyron.builder.api.artifacts.ArtifactRepositoryContainer#DEFAULT_MAVEN_CENTRAL_REPO_NAME}.
     *
     * <p>Examples:</p>
     * <pre class='autoTested'>
     * repositories {
     ...
     * {@value com.tyron.builder.api.artifacts.ArtifactRepositoryContainer#DEFAULT_MAVEN_LOCAL_REPO_NAME}.
     *
     * <p>Examples:</p>
     * <pre class='autoTested'>
     * repositories {

 ...
 * </ol>
 * <p>
 * Repositories of this type are created by the {@link com.tyron.builder.api.artifacts.dsl.RepositoryHandler#ivy(com.tyron.builder.api.Action)} group of methods.
 */
public interface IvyArtifactRepository extends ArtifactRepository, UrlArtifactRepository, AuthenticationSupported, MetadataSupplierAware {
    ...
    /**
     * Sets the base URL of this repository. The provided value is evaluated as per {@link com.tyron.builder.api.Project#uri(Object)}. This means,

 ...
 * <p>
 * Repositories of this type are created by the {@link com.tyron.builder.api.artifacts.dsl.RepositoryHandler#maven(com.tyron.builder.api.Action)} group of methods.
 */
public interface MavenArtifactRepository extends ArtifactRepository, UrlArtifactRepository, AuthenticationSupported, MetadataSupplierAware {
     ...
     * #setArtifactUrls(Iterable)}.
     *
     * <p>The provided value is evaluated as per {@link com.tyron.builder.api.BuildProject#uri(Object)}. This means, for example, you can pass in a {@code File} object, or a relative path to be evaluated relative
     ...
     *
     * <p>The provided values are evaluated as per {@link com.tyron.builder.api.BuildProject#uri(Object)}. This means, for example, you can pass in a {@code File} object, or a relative path to be evaluated

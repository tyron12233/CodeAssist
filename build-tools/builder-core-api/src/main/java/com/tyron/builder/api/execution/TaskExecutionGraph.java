 ...
 *
 * <p>You can access the {@code TaskExecutionGraph} by calling {@link com.tyron.builder.api.invocation.Gradle#getTaskGraph()}.
...
public interface TaskExecutionGraph {
     ...
     * first parameter. A {@link com.tyron.builder.api.tasks.TaskState} is passed as the second parameter. Both parameters are
     * optional.</p>
     *

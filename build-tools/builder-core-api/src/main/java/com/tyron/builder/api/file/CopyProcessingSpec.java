...
public interface CopyProcessingSpec extends ContentFilterable {
     ...
     * com.tyron.builder.api.Project#file(Object)}.
     *
     ...
     * called with a {@link com.tyron.builder.api.file.FileCopyDetails} as its parameter. Actions are executed in the order

 ...
 *
 * <p>You can create an instance of {@code SourceDirectorySet} using the {@link com.tyron.builder.api.model.ObjectFactory#sourceDirectorySet(String, String)} method.</p>
 */
public interface SourceDirectorySet extends FileTree, PatternFilterable, Named, Describable {
     ...
     *
     * @param srcPath The source directory. This is evaluated as per {@link com.tyron.builder.api.Project#files(Object...)}
     * @return this
     */
     ...
     *
     * @param srcPaths The source directories. These are evaluated as per {@link com.tyron.builder.api.Project#files(Object...)}
     * @return this
     */

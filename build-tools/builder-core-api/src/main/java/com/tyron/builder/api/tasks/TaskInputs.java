...
import com.tyron.builder.api.internal.tasks.TaskInputPropertyBuilder;
...
public interface TaskInputs {
     ...
     *
     * <p>If the value is not known when registering the input, a {@link Provider} can be
     ...
     * Instead always use call via {@link Task#getInputs()}.</p>
     *

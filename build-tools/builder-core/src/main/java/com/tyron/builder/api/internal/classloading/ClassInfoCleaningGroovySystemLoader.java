...
public class ClassInfoCleaningGroovySystemLoader implements GroovySystemLoader {
    ...
    private final static Logger LOG =
            LoggerFactory.getLogger(ClassInfoCleaningGroovySystemLoader.class);
    ...
    public ClassInfoCleaningGroovySystemLoader(ClassLoader leakingLoader) throws Exception {
        ...
        Class<?> classInfoClass =
                leakingLoader.loadClass("org.codehaus.groovy.reflection.ClassInfo");
        ...
        removeFromGlobalClassValue =
                globalClassValueField.getType().getDeclaredMethod("remove", Class.class);
            ...
            while (it.hasNext()) {
                ...
                if (classInfo != null) {
                    ...
                    if (LOG.isDebugEnabled()) {
                        LOG.debug("Removed ClassInfo from {} loaded by {}", clazz.getName(),

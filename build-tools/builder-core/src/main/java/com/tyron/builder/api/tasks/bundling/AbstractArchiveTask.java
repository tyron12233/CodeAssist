...
import com.tyron.builder.api.tasks.AbstractCopyTask;
...
public abstract class AbstractArchiveTask extends AbstractCopyTask {
    ...
    public Provider<RegularFile> getArchiveFile() {
         ...
         * prevent users calling {@link com.tyron.builder.api.provider.Property#set} and causing a plugin or users using
     ...
     * The destination is evaluated as per {@link com.tyron.builder.api.Project#file(Object)}.

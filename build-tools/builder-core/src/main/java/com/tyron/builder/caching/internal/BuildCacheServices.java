        ...
        registration.addProvider(new Object() {
            ...
            BuildCacheConfigurationInternal createBuildCacheConfiguration(
                ...
                return DirectInstantiator.INSTANCE
                        .newInstance(DefaultBuildCacheConfiguration.class, DirectInstantiator.INSTANCE, allBuildCacheServiceFactories);
            }
        ...
        registration.addProvider(new Object() {
            ...
            OriginMetadataFactory createOriginMetadataFactory(
                ...
                return new OriginMetadataFactory(
                        ...
                        properties -> properties.setProperty(GRADLE_VERSION_KEY, DocumentationRegistry.GradleVersion.current().getVersion()),

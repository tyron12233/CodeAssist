package com.tyron.builder.caching.internal.services;
...
import com.tyron.builder.caching.internal.FinalizeBuildCacheConfigurationBuildOperationType;
...
import com.tyron.builder.caching.internal.controller.NoOpBuildCacheController;
import com.tyron.builder.caching.internal.controller.service.BuildCacheServiceRole;
...
public final class BuildCacheControllerFactory {
    ...
    public static final String REMOTE_CONTINUE_ON_ERROR_PROPERTY = "com.tyron.builder.unsafe.build-cache.remote-continue-on-error";

...
import static com.tyron.builder.api.util.GFileUtils.canonicalize;
...
public class BuildLayoutParameters {
    ...
    public BuildLayoutParameters() {
        this(
                ...
                null,
                GFileUtils.canonicalize(SystemProperties.getInstance().getCurrentDir())
        );
    }
    ...
    static private File findGradleUserHomeDir() {
        ...
        return GFileUtils.canonicalize(new File(gradleUserHome));
    }

...
public interface BuildTreeLifecycleController {
    ...
    /**
     * Schedules the work graph for the tasks specified in the {@link StartParameter} associated with the build, runs the scheduled work and finishes up the build.
     * When this method returns, all user code will have completed, including 'build finished' hooks.
     *
    ...
    /**
     * Configures the build, optionally schedules and runs any tasks specified in the {@lin StartParameter} associated with the build, calls the given action and finally finishes up the build.
     * When this method returns, all user code will have completed, including 'build finished' hooks.
     *

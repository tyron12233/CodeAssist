...
import com.tyron.builder.api.XmlProvider;
import com.tyron.builder.api.internal.DomNode;
...
public class XmlTransformer implements Transformer<String, String> {
    ...
    public void transform(File destination, final String encoding, final Action<? super Writer> generator) {
        IoActions.writeTextFile(destination, encoding,
                (Action<Writer>) writer -> transform(writer, encoding, generator));
    }

    public void transform(File destination, final Action<? super Writer> generator) {
        IoActions.writeTextFile(destination,
                (Action<Writer>) writer -> transform(writer, generator));
    }

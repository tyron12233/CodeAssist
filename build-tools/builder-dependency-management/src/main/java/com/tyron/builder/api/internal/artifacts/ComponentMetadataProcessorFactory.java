 ...
 * <p>
 * In a build, {@link com.tyron.builder.api.artifacts.ComponentMetadataRule component metadata rules} can be added to transform dependencies metadata.
 * These are registered with the {@link com.tyron.builder.api.artifacts.dsl.ComponentMetadataHandler ComponentMetadataHandler} which does not have contextual information,

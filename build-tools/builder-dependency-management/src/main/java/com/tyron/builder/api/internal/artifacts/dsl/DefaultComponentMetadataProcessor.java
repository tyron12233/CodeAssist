...
import com.tyron.builder.api.internal.artifacts.ivyservice.ivyresolve.UserProvidedMetadata;
...
import com.tyron.builder.internal.serialize.OutputStreamBackedEncoder;
...
public class DefaultComponentMetadataProcessor implements ComponentMetadataProcessor {
    ...
    private final static boolean FORCE_REALIZE = Boolean.getBoolean("com.tyron.builder.integtest.force.realize.metadata");

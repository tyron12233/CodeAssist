...
public class ParsedModuleStringNotation {
    ...
    private void assignValuesFromModuleNotation(String moduleNotation) {
        ...
        count++;
        if (count < 2 || count > 4) {
            throw new IllegalDependencyNotation("Supplied String module notation '" + moduleNotation + "' is invalid. Example notations: 'com.tyron.builder:gradle-core:2.2', 'org.mockito:mockito-core:1.9.5:javadoc'.");
        }
    }

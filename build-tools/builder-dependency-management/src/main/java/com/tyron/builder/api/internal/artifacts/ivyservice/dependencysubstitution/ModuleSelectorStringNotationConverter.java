...
import static com.tyron.builder.api.internal.notations.ModuleNotationValidation.*;
...
public class ModuleSelectorStringNotationConverter extends TypedNotationConverter<String, ComponentSelector> {
    ...
    public void describe(DiagnosticsVisitor visitor) {
        visitor.candidate("String describing the module in 'group:name' format").example("'com.tyron.builder:gradle-core'.");
        visitor.candidate("String describing the selector in 'group:name:version' format").example("'com.tyron.builder:gradle-core:1.+'.");
    }
}

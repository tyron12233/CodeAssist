...
import com.tyron.builder.api.internal.artifacts.repositories.transport.NetworkingIssueVerifier;
...
import com.tyron.builder.internal.resolve.result.ErroringResolveResult;
...
public class ErrorHandlingModuleComponentRepository implements ModuleComponentRepository {
    ...
    private static final class ErrorHandlingModuleComponentRepositoryAccess implements ModuleComponentRepositoryAccess {
        ...
        private final static String MAX_TENTATIVES_BEFORE_BLACKLISTING = "com.tyron.builder.internal.repository.max.tentatives";
        private final static String INITIAL_BACKOFF_MS = "com.tyron.builder.internal.repository.initial.backoff";

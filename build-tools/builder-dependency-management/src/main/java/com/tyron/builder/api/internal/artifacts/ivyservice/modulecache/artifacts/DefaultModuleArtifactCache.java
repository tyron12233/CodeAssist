...
import com.tyron.builder.api.internal.artifacts.metadata.ComponentArtifactIdentifierSerializer;
import com.tyron.builder.api.internal.artifacts.metadata.ModuleComponentFileArtifactIdentifierSerializer;
...
import com.tyron.builder.internal.resource.cached.AbstractCachedIndex;
...
public class DefaultModuleArtifactCache extends AbstractCachedIndex<ArtifactAtRepositoryKey,
    ...
    static class CachedArtifactSerializer implements Serializer<CachedArtifact> {
        ...
        public void write(Encoder encoder, CachedArtifact value) throws Exception {
            ...
            byte[] hash = value.getDescriptorHash().asBytes();

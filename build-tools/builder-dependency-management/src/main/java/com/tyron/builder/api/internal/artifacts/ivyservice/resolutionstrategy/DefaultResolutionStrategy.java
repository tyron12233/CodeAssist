...
import com.tyron.builder.api.artifacts.CapabilitiesResolution;
import com.tyron.builder.api.artifacts.ComponentSelection;
import com.tyron.builder.api.artifacts.ComponentSelectionRules;
import com.tyron.builder.api.artifacts.DependencyResolveDetails;
...
import com.tyron.builder.api.internal.artifacts.dsl.ModuleVersionSelectorParsers;
...
import com.tyron.builder.internal.typeconversion.NormalizedTimeUnit;
import com.tyron.builder.internal.typeconversion.NotationParser;
import com.tyron.builder.internal.typeconversion.TimeUnitsParser;
...
public class DefaultResolutionStrategy implements ResolutionStrategyInternal {
    ...
    private static final String ASSUME_FLUID_DEPENDENCIES = "com.tyron.builder.resolution.assumeFluidDependencies";
    ...
    public DefaultResolutionStrategy(DependencySubstitutionRules globalDependencySubstitutionRules,
        ...
        this(new DefaultCachePolicy(), DefaultDependencySubstitutions
                .forResolutionStrategy(componentIdentifierFactory, moduleSelectorNotationParser, instantiator, objectFactory, attributesFactory, capabilitiesNotationParser), globalDependencySubstitutionRules, vcsResolver, moduleIdentifierFactory, componentSelectorConverter, dependencyLockingProvider, capabilitiesResolution);
    }

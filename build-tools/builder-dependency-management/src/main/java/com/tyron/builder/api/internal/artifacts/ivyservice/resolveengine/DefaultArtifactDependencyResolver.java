...
import com.tyron.builder.api.internal.artifacts.ivyservice.dependencysubstitution.CachingDependencySubstitutionApplicator;
import com.tyron.builder.api.internal.artifacts.ivyservice.dependencysubstitution.DefaultDependencySubstitutionApplicator;
...
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.artifact.ResolvedArtifactsGraphVisitor;
...
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.graph.builder.DependencyGraphBuilder;
...
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.graph.conflicts.DefaultConflictHandler;
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.graph.conflicts.LastCandidateCapabilityResolver;
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.graph.conflicts.ModuleConflictHandler;
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.graph.conflicts.RejectRemainingCandidates;
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.graph.conflicts.UserConfiguredCapabilityResolver;
...
import com.tyron.builder.api.internal.artifacts.ivyservice.clientmodule.ClientModuleResolver;
...
public class DefaultArtifactDependencyResolver implements ArtifactDependencyResolver {
    ...
    @Override
    public void resolve(ResolveContext resolveContext, List<? extends ResolutionAwareRepository> repositories, GlobalDependencyResolutionRules metadataHandler, Predicate<? super DependencyMetadata> edgeFilter, DependencyGraphVisitor graphVisitor, DependencyArtifactsVisitor artifactsVisitor, AttributesSchemaInternal consumerSchema, ArtifactTypeRegistry artifactTypeRegistry, boolean includeSyntheticDependencies) {
    ...
    private DependencyGraphBuilder createDependencyGraphBuilder(ComponentResolversChain componentSource,
        ...
        ModuleConflictHandler
                conflictHandler = createModuleConflictHandler(resolutionStrategy, globalRules);
    ...
    private DependencySubstitutionApplicator createDependencySubstitutionApplicator(ResolutionStrategyInternal resolutionStrategy) {
        ...
        if (Actions.<DependencySubstitution>doNothing() == rule) {
            applicator = DependencySubstitutionApplicator.NO_OP;
        } else {

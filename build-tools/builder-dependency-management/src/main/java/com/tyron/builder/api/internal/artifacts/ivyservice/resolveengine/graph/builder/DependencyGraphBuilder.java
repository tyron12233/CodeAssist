...
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.graph.conflicts.CapabilitiesConflictHandler;
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.graph.conflicts.DefaultCapabilitiesConflictHandler;
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.graph.conflicts.ModuleConflictHandler;
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.graph.conflicts.PotentialConflict;
import com.tyron.builder.internal.component.IncompatibleVariantsSelectionException;
...
import com.tyron.builder.api.internal.artifacts.ResolvedVersionConstraint;
import com.tyron.builder.api.internal.artifacts.configurations.ResolutionStrategyInternal;
import com.tyron.builder.api.internal.artifacts.ivyservice.dependencysubstitution.DependencySubstitutionApplicator;
import com.tyron.builder.api.internal.artifacts.ivyservice.ivyresolve.strategy.Version;
...
import com.tyron.builder.api.internal.attributes.CompatibilityRule;
...
import com.tyron.builder.internal.component.local.model.RootLocalComponentMetadata;
import com.tyron.builder.internal.component.model.ComponentResolveMetadata;
import com.tyron.builder.internal.component.model.DefaultCompatibilityCheckResult;
...
import com.tyron.builder.internal.operations.BuildOperationConstraint;
...
import com.tyron.builder.internal.resolve.resolver.ResolveContextToComponentResolver;
...
public class DependencyGraphBuilder {
    ...
    private final Predicate<? super DependencyMetadata> edgeFilter;
    ...
    final static Predicate<EdgeState> ENDORSE_STRICT_VERSIONS_DEPENDENCY_SPEC = dependencyState -> dependencyState.getDependencyState().getDependency().isEndorsingStrictVersions();
    final static Predicate<EdgeState> NOT_ENDORSE_STRICT_VERSIONS_DEPENDENCY_SPEC = dependencyState -> !dependencyState.getDependencyState().getDependency().isEndorsingStrictVersions();
    ...
    public DependencyGraphBuilder(DependencyToComponentIdResolver componentIdResolver,
                                  ...
                                  Predicate<? super DependencyMetadata> edgeFilter,
        ...
        node.forEachCapability(capabilitiesConflictHandler, new Action<Capability>() {
            ...
            public void execute(Capability capability) {
                ...
                PotentialConflict c = capabilitiesConflictHandler.registerCandidate(
                    DefaultCapabilitiesConflictHandler
                            .candidate(node, capability, implicitProvidersForCapability)
                );
                if (c.conflictExists()) {
    ...
    private boolean resolveEdges(final NodeState node,
                                 ...
                                 final Predicate<EdgeState> dependencyFilter,
    ...
    private boolean performSelectionSerially(List<EdgeState> dependencies, Predicate<EdgeState> dependencyFilter, ResolveState resolveState, boolean recomputeSelectors) {
     ...
     */
    private void maybeDownloadMetadataInParallel(NodeState node, Map<ModuleVersionIdentifier, ComponentIdentifier> componentIdentifierCache, List<EdgeState> dependencies, Predicate<EdgeState> dependencyFilter) {
    ...
    private void attachToTargetRevisionsSerially(List<EdgeState> dependencies, Predicate<EdgeState> dependencyFilter) {

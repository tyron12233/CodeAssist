...
import com.tyron.builder.api.internal.artifacts.ivyservice.dependencysubstitution.ArtifactSelectionDetailsInternal;
...
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.strict.StrictVersionConstraints;
...
import com.tyron.builder.internal.component.external.model.ShadowedCapability;
...
import com.tyron.builder.internal.component.model.SelectedByVariantMatchingConfigurationMetadata;
...
public class NodeState implements DependencyGraphNode {
    ...
    private boolean isExcluded(ExcludeSpec excludeSpec, DependencyState dependencyState) {
        ...
        if (!resolveState.getEdgeFilter().test(dependency)) {
    ...
    void collectEndorsedStrictVersions(List<EdgeState> dependencies) {
        ...
        for (EdgeState edgeState : dependencies) {
            if (!DependencyGraphBuilder.ENDORSE_STRICT_VERSIONS_DEPENDENCY_SPEC.test(edgeState)) {
                continue;
            }
            if (endorsesStrictVersionsFrom == null) {

...
package com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.store;
...
public class CachedStoreFactory<T> implements Closeable {
    ...
    private static final int CACHE_SIZE = Integer.getInteger("com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.store.cacheSize", 100);
    private static final int CACHE_EXPIRY = Integer.getInteger("com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.store.cacheExpiryMs", 10000);

...
import com.tyron.builder.api.internal.artifacts.repositories.descriptor.FlatDirRepositoryDescriptor;
...
import com.tyron.builder.internal.resolve.caching.ImplicitInputRecorder;
import com.tyron.builder.internal.resolve.caching.ImplicitInputsProvidingService;
...
public class DefaultFlatDirArtifactRepository extends AbstractResolutionAwareArtifactRepository implements FlatDirectoryArtifactRepository, ResolutionAwareRepository, PublicationAwareRepository {
    ...
    private ImmutableMetadataSources createMetadataSources() {
        MetadataSource<MutableModuleComponentResolveMetadata>
                artifactMetadataSource = new DefaultArtifactMetadataSource(metadataFactory);

...
import com.tyron.builder.api.artifacts.DependenciesMetadata;
...
public abstract class AbstractDependenciesMetadataAdapter<T extends DependencyMetadata<T>> extends AbstractList<T> implements DependenciesMetadata<T> {
    private final List<com.tyron.builder.internal.component.model.DependencyMetadata> dependenciesMetadata;
    ...
    public AbstractDependenciesMetadataAdapter(ImmutableAttributesFactory attributesFactory, List<com.tyron.builder.internal.component.model.DependencyMetadata> dependenciesMetadata, Instantiator instantiator, NotationParser<Object, T> dependencyNotationParser) {
    ...
    private com.tyron.builder.internal.component.model.DependencyMetadata toDependencyMetadata(T details) {

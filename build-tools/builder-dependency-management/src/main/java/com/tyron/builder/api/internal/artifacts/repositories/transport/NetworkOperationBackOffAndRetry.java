...
public class NetworkOperationBackOffAndRetry {
    private final static String MAX_ATTEMPTS = "com.tyron.builder.internal.network.retry.max.attempts";
    private final static String INITIAL_BACKOFF_MS = "com.tyron.builder.internal.network.retry.initial.backOff";

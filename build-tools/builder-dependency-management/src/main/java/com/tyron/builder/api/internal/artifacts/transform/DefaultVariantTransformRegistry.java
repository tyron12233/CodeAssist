...
public class DefaultVariantTransformRegistry implements VariantTransformRegistry {
    ...
    @SuppressWarnings("deprecation")
    @NonExtensible
    public static class UntypedRegistration extends RecordingRegistration implements com.tyron.builder.api.artifacts.transform.VariantTransform {
        private Action<? super ActionConfiguration> configAction;
        private final InstantiatorFactory instantiatorFactory;
        Class<? extends com.tyron.builder.api.artifacts.transform.ArtifactTransform> actionType;
        ...
        @Override
        public void artifactTransform(Class<? extends com.tyron.builder.api.artifacts.transform.ArtifactTransform> type) {
            artifactTransform(type, null);
        }

        @Override
        public void artifactTransform(Class<? extends com.tyron.builder.api.artifacts.transform.ArtifactTransform> type, @Nullable Action<? super ActionConfiguration> config) {

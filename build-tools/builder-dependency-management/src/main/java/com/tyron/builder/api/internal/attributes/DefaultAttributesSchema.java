...
import com.tyron.builder.internal.component.model.AttributeMatchingExplanationBuilder;
import com.tyron.builder.internal.component.model.AttributeSelectionSchema;
import com.tyron.builder.internal.component.model.AttributeSelectionUtils;
...
import com.tyron.builder.internal.component.model.DefaultMultipleCandidateResult;
...
public class DefaultAttributesSchema implements AttributesSchemaInternal, AttributesSchema {
    ...
    private class MergedSchema implements AttributeSelectionSchema {
        ...
        public Attribute<?>[] collectExtraAttributes(ImmutableAttributes[] candidateAttributeSets, ImmutableAttributes requested) {
            ...
            if (attributes == null) {
                attributes = AttributeSelectionUtils
                        .collectExtraAttributes(this, candidateAttributeSets, requested);

...
public class AbstractProjectAccessorsSourceGenerator extends AbstractSourceGenerator {
    ...
    protected void writeHeader(String packageName) throws IOException {
        ...
        writeLn();
        addImport("com.tyron.builder.api.NonNullApi");
        addImport("com.tyron.builder.api.artifacts.ProjectDependency");
        addImport("com.tyron.builder.api.internal.artifacts.dependencies.ProjectDependencyInternal");
        addImport("com.tyron.builder.api.internal.artifacts.DefaultProjectDependencyFactory");
        addImport("com.tyron.builder.api.internal.artifacts.dsl.dependencies.ProjectFinder");
        addImport("com.tyron.builder.api.internal.catalog.DelegatingProjectDependency");
        addImport("com.tyron.builder.api.internal.catalog.TypeSafeProjectDependencyFactory");

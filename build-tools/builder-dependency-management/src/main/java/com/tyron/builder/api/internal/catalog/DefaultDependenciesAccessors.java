...
import com.tyron.builder.internal.execution.fingerprint.InputFingerprinter.InputPropertyType;
...
import com.tyron.builder.util.internal.IncubationLogger;
...
public class DefaultDependenciesAccessors implements DependenciesAccessors {
    ...
    private final static String ACCESSORS_PACKAGE = "com.tyron.builder.accessors.dm";
    ...
    private abstract class AbstractAccessorUnitOfWork implements UnitOfWork {
        ...
        public Identity identify(Map<String, ValueSnapshot> identityInputs, Map<String, CurrentFileCollectionFingerprint> identityFileInputs) {
            return () -> {
                Hasher hasher = Hashes.sha1().newHasher();

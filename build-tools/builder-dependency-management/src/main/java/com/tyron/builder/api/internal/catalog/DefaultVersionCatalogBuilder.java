...
import com.tyron.builder.api.internal.catalog.parser.DependenciesModelHelper;
import com.tyron.builder.api.internal.catalog.parser.StrictVersionParser;
import com.tyron.builder.api.internal.catalog.parser.TomlCatalogFileParser;
import com.tyron.builder.api.internal.catalog.problems.VersionCatalogProblemBuilder;
import com.tyron.builder.api.internal.catalog.problems.VersionCatalogProblemId;
...
import com.tyron.builder.internal.management.VersionCatalogBuilderInternal;
...
import static com.tyron.builder.api.internal.catalog.AliasNormalizer.normalize;
import static com.tyron.builder.api.internal.catalog.problems.DefaultCatalogProblemBuilder.buildProblem;
import static com.tyron.builder.api.internal.catalog.problems.DefaultCatalogProblemBuilder.maybeThrowError;
import static com.tyron.builder.problems.internal.RenderingUtils.oxfordListOf;
...
public class DefaultVersionCatalogBuilder implements VersionCatalogBuilderInternal {
    ...
    private void importCatalogFromFile(File modelFile) {
        if (!GFileUtils.hasExtensionIgnoresCase(modelFile.getName(), "toml")) {

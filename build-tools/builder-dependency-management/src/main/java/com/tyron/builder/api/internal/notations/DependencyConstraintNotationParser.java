...
public class DependencyConstraintNotationParser {
    ...
    private static class MinimalExternalDependencyNotationConverter implements NotationConverter<MinimalExternalModuleDependency, DefaultDependencyConstraint> {
        ...
        public void convert(MinimalExternalModuleDependency notation,
                            NotationConvertResult<? super DefaultDependencyConstraint> result) throws TypeConversionException {
            DefaultDependencyConstraint dependencyConstraint = instantiator
                    .newInstance(DefaultDependencyConstraint.class, notation.getModule(),
    ...
    private final static class UnsupportedCapabilitiesHandler implements ModuleDependencyCapabilitiesHandler {
        private final static UnsupportedCapabilitiesHandler INSTANCE =
                new UnsupportedCapabilitiesHandler();

        @Override
        public void requireCapability(Object capabilityNotation) {
            throw new InvalidUserDataException(
                    "Capabilies are not supported by dependency constraints");
        }

...
import com.tyron.builder.api.internal.component.BuildableJavaComponent;
...
import com.tyron.builder.api.tasks.diagnostics.BuildEnvironmentReportTask;
import com.tyron.builder.api.tasks.diagnostics.DependencyInsightReportTask;
import com.tyron.builder.api.tasks.diagnostics.DependencyReportTask;
import com.tyron.builder.api.tasks.diagnostics.OutgoingVariantsReportTask;
import com.tyron.builder.api.tasks.diagnostics.ProjectReportTask;
import com.tyron.builder.api.tasks.diagnostics.PropertyReportTask;
import com.tyron.builder.api.tasks.diagnostics.TaskReportTask;
import com.tyron.builder.configuration.Help;
...
public class HelpTasksPlugin implements Plugin<BuildProject> {
    ...
    private void registerDeprecatedTasks(TaskContainer tasks, String projectName) {
        tasks.register(COMPONENTS_TASK, com.tyron.builder.api.reporting.components.ComponentReport.class, new ComponentReportAction(projectName));
        tasks.register(MODEL_TASK, com.tyron.builder.api.reporting.model.ModelReport.class, new ModelReportAction(projectName));
        tasks.register(DEPENDENT_COMPONENTS_TASK, com.tyron.builder.api.reporting.dependents.DependentComponentsReport.class, new DependentComponentsReportAction(projectName));
    }
    ...
    @SuppressWarnings("deprecation")
    private static class ComponentReportAction implements Action<com.tyron.builder.api.reporting.components.ComponentReport> {
        private final String projectName;
        ...
        @Override
        public void execute(com.tyron.builder.api.reporting.components.ComponentReport task) {
    ...
    @SuppressWarnings("deprecation")
    private static class ModelReportAction implements Action<com.tyron.builder.api.reporting.model.ModelReport> {
        private final String projectName;
        ...
        @Override
        public void execute(com.tyron.builder.api.reporting.model.ModelReport task) {
    ...
    @SuppressWarnings("deprecation")
    private static class DependentComponentsReportAction implements Action<com.tyron.builder.api.reporting.dependents.DependentComponentsReport> {
        private final String projectName;
        ...
        @Override
        public void execute(com.tyron.builder.api.reporting.dependents.DependentComponentsReport task) {

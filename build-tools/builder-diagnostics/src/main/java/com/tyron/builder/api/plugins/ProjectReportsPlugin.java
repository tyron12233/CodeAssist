...
import com.tyron.builder.api.reporting.dependencies.HtmlDependencyReportTask;
 ...
 */
public class ProjectReportsPlugin implements Plugin<BuildProject> {
    ...
    public void apply(final BuildProject project) {
        ...
        final ProjectReportsPluginConvention convention = new com.tyron.builder.api.plugins.internal.DefaultProjectReportsPluginConvention(project);
        @SuppressWarnings("deprecation")

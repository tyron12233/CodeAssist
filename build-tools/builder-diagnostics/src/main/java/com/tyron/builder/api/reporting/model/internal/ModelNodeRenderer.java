...
package com.tyron.builder.api.reporting.model.internal;
...
public class ModelNodeRenderer extends ReportRenderer<ModelNode, TextReportBuilder> {
    ...
    private final com.tyron.builder.api.reporting.model.ModelReport.Format format;

    @SuppressWarnings("deprecation")
    public ModelNodeRenderer(boolean showHidden, com.tyron.builder.api.reporting.model.ModelReport.Format format) {
    ...
    private boolean omitDetails() {
        return com.tyron.builder.api.reporting.model.ModelReport.Format.SHORT == format;
    }

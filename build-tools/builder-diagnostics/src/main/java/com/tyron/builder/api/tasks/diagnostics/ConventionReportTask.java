...
import static com.tyron.builder.internal.serialization.Transient.varOf;
...
import com.tyron.builder.internal.serialization.Transient;
...
public abstract class ConventionReportTask extends ConventionTask {
     ...
     * <p>
     * The {@code project-report} plugin sets the default value for all tasks of this type to
     * {@code buildDir/project}.
     * <p>

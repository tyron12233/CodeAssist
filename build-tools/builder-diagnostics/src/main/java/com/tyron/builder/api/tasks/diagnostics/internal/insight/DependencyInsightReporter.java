...
package com.tyron.builder.api.tasks.diagnostics.internal.insight;
...
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.result.ComponentSelectionReasonInternal;
import com.tyron.builder.api.internal.artifacts.ivyservice.resolveengine.result.ComponentSelectionReasons;
import com.tyron.builder.api.tasks.diagnostics.internal.graph.nodes.DefaultSection;
import com.tyron.builder.api.tasks.diagnostics.internal.graph.nodes.DependencyEdge;
import com.tyron.builder.api.tasks.diagnostics.internal.graph.nodes.DependencyReportHeader;
import com.tyron.builder.api.tasks.diagnostics.internal.graph.nodes.RenderableDependency;
import com.tyron.builder.api.tasks.diagnostics.internal.graph.nodes.RequestedVersion;
import com.tyron.builder.api.tasks.diagnostics.internal.graph.nodes.ResolvedDependencyEdge;
import com.tyron.builder.api.tasks.diagnostics.internal.graph.nodes.Section;
import com.tyron.builder.api.tasks.diagnostics.internal.graph.nodes.UnresolvedDependencyEdge;

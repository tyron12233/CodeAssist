...
public abstract class XmlPersistableConfigurationObject extends AbstractPersistableConfigurationObject {
    ...
    public void load(InputStream inputStream) throws Exception {
        Class<?> aClass = Class.forName("groovy.xml.XmlParser");
        Object xmlParser = aClass.getConstructor().newInstance();
        Method parse = aClass.getDeclaredMethod("parse", InputStream.class);
        parse.invoke(xmlParser, inputStream);
        load(xml);
    }

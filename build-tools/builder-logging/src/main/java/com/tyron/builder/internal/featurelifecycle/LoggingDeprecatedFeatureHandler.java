...
//import com.tyron.builder.internal.logging.LoggingConfigurationBuildOptions;
import com.tyron.builder.internal.operations.BuildOperationProgressEventEmitter;
//import com.tyron.builder.util.internal.DefaultGradleVersion;
...
public class LoggingDeprecatedFeatureHandler implements FeatureHandler<DeprecatedFeatureUsage> {
    public static final String ORG_GRADLE_DEPRECATION_TRACE_PROPERTY_NAME = "com.tyron.builder.deprecation.trace";

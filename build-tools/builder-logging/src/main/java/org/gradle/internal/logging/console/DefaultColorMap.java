...
public class DefaultColorMap implements ColorMap {
     ...
     * {@link org.gradle.internal.logging.console.ColorMap.Color} that has been created
     * for it
     */
    private final Map<String, Color> colorByStyle = new HashMap<>();

    /**
     * Maps a color spec to the {@link org.gradle.internal.logging.console.ColorMap.Color}

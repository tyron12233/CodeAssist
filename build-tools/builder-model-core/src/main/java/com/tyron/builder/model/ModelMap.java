 ...
 * <p>
 * {@link com.tyron.builder.model.Managed} types may declare model map properties.
...
public interface ModelMap<T> extends Iterable<T>, ModelElement {
     ...
     *
     * <p>The given action is invoked to configure the item when the item is required. It is called after any actions provided to {@link #beforeEach(com.tyron.builder.api.Action)} and {@link #create(String,
     * com.tyron.builder.api.Action)}.
     *
     * @param name The name.
     ...
     *
     * <p>The given action is invoked to configure the item when the item is required. It is called before any actions provided to {@link #create(String, com.tyron.builder.api.Action)}.
     *
     * @param configAction An action that configures the item. The action is executed when the item is required.
     */
     ...
     * Applies the given action to each item in the collection, as each item is required.
     *
     * <p>The given action is invoked to configure the item when the item is required. It is called after any actions provided to {@link #beforeEach(com.tyron.builder.api.Action)}, {@link #create(String,
     * com.tyron.builder.api.Action)}, and other mutation methods.
     *
     * @param configAction An action that configures the item. The action is executed when the item is required.
     */

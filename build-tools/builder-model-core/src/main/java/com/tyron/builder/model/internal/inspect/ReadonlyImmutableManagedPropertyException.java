...
public class ReadonlyImmutableManagedPropertyException extends BuildException {
    ...
    private static String toMessage(ModelType<?> managedModelType,
                                    String name,
                                    ModelType<?> propertyType) {
        return String
                .format("Invalid managed model type '%s': read only property '%s' has non managed type %s, only managed types can be used",

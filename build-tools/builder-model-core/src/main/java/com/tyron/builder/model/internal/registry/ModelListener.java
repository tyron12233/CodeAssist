...
import com.tyron.builder.model.internal.core.ModelPredicate;

abstract class ModelListener extends ModelPredicate {
    /**
     * Invoked once for each node when the node reaches the {@link com.tyron.builder.model.internal.core.ModelNode.State#Discovered} state

...
import com.tyron.builder.model.internal.report.unbound.UnboundRuleInput;
...
class UnboundRulesProcessor {
    ...
    private UnboundRuleInput.Builder toInputBuilder(ModelBinding binding) {
        ...
        if (binding.isBound()) {
            ...
            if (path != null) {
                builder.suggestions(ImmutableList.copyOf(CollectionUtils.stringize(suggestionsProvider.transform(path))));
            }

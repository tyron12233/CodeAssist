...
import com.tyron.builder.api.internal.Specs;
...
public class DomainObjectCollectionBackedModelMap<T> extends ModelMapGroovyView<T> {
    ...
    private final com.tyron.builder.api.Namer<? super T> namer;
    private final Action<? super T> onCreateAction;

    public DomainObjectCollectionBackedModelMap(String name, Class<T> elementType, DomainObjectCollection<T> backingCollection, NamedEntityInstantiator<T> instantiator, com.tyron.builder.api.Namer<? super T> namer, Action<? super T> onCreateAction) {
        this.name = name;
    ...
    private <S> ModelMap<S> toNonSubtypeMap(Class<S> type) {
        ...
        com.tyron.builder.api.Namer<S> castNamer = Cast.uncheckedCast(namer);
    ...
    private static class HasNamePredicate<T> implements Predicate<T> {
        ...
        public HasNamePredicate(String name, com.tyron.builder.api.Namer<? super T> namer) {
            this.name = name;
            this.namer = namer;
        }
    ...
    private static class ToName<T> implements Function<T, String> {
        ...
        public ToName(com.tyron.builder.api.Namer<? super T> namer) {
            this.namer = namer;
        }
    ...
    public static <T> DomainObjectCollectionBackedModelMap<T> wrap(String name, Class<T> elementType, DomainObjectCollection<T> domainObjectSet, NamedEntityInstantiator<T> instantiator, com.tyron.builder.api.Namer<? super T> namer, Action<? super T> onCreate) {

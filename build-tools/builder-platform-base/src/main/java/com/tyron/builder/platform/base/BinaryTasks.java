...
/**
 * Declares the tasks to build a custom {@link com.tyron.builder.platform.base.BinarySpec} binary.
 *
 * The following example demonstrates how to register multiple tasks for custom binary using a plugin with a
 * {@link com.tyron.builder.platform.base.BinaryTasks} annotation.
 *

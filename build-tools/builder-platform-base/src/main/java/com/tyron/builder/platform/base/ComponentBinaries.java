...
/**
 * Declares the binaries that should be built for a custom {@link com.tyron.builder.platform.base.ComponentSpec} type.
 *
 * The following example demonstrates how to register a binary for a custom component type using a plugin with a
 * {@link com.tyron.builder.platform.base.ComponentBinaries} annotation.
 * Furthermore the plugin registers 'DefaultSampleBinary' as implementation for {@link com.tyron.builder.platform.base.BinarySpec}.
 *

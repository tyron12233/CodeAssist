...
import com.tyron.builder.platform.base.ModuleDependencySpecBuilder;
   ...
   public static class Builder implements ModuleDependencySpecBuilder {
       ...
       private IllegalDependencyNotation illegalNotation(String moduleId) {
           return new IllegalDependencyNotation(
               String.format(
                   "'%s' is not a valid module dependency notation. Example notations: 'com.tyron.builder:gradle-core:2.2', 'org.mockito:mockito-core'.",
                   moduleId));
       }

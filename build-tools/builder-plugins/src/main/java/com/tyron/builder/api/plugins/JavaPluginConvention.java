...
/**
 * Is mixed into the project when applying the {@link com.tyron.builder.api.plugins.JavaBasePlugin} or the
 * {@link com.tyron.builder.api.plugins.JavaPlugin}.
 *
...
public abstract class JavaPluginConvention {
    ...
    /**
     * The name of the test reports directory. Can be a name or a path relative to {@link com.tyron.builder.api.reporting.ReportingExtension#getBaseDir}.
     */

...
public interface JavaPluginExtension {
     ...
     * <P>
     * The publishing of the Javadoc variant can also be disabled using {@link com.tyron.builder.api.component.ConfigurationVariantDetails#skip()}
     * through {@link com.tyron.builder.api.component.AdhocComponentWithVariants#withVariantsFromConfiguration(Configuration, Action)},
    ...
    /**
     * Adds a task {@code sourcesJar} that will package the Java sources of the main {@link com.tyron.builder.api.tasks.SourceSet SourceSet} in a JAR with classifier {@code sources}.
     * <P>
     * The produced artifact is registered as a documentation variant on the {@code java} component and added as a dependency on the {@code assemble} task.
     ...
     * <P>
     * The publishing of the sources variant can be disabled using {@link com.tyron.builder.api.component.ConfigurationVariantDetails#skip()}
     * through {@link com.tyron.builder.api.component.AdhocComponentWithVariants#withVariantsFromConfiguration(Configuration, Action)},
    ...
    /**
     * Gets the project wide toolchain requirements that will be used for tasks requiring a tool from the toolchain (e.g. {@link com.tyron.builder.api.tasks.compile.JavaCompile}).
     * <p>
    ...
    /**
     * Configures the project wide toolchain requirements for tasks that require a tool from the toolchain (e.g. {@link com.tyron.builder.api.tasks.compile.JavaCompile}).
     * <p>
     * Configuring a toolchain cannot be used together with {@code sourceCompatibility} or {@code targetCompatibility} on this extension.
     * Both values will be sourced from the toolchain.
     *
     ...
     * <p>
     * See the example below how {@link com.tyron.builder.api.tasks.SourceSet} 'main' is accessed and how the {@link com.tyron.builder.api.file.SourceDirectorySet} 'java'
     ...
     * @return NamedDomainObjectContainer&lt;com.tyron.builder.api.tasks.SourceSet&gt;
     * @since 7.1
     */

 ...
 * @since 7.3
 *
 * @see com.tyron.builder.api.artifacts.dsl.DependencyHandler For more information.
 */
@Incubating
public interface JvmComponentDependencies {
     ...
     * @see com.tyron.builder.api.artifacts.dsl.DependencyHandler Valid dependency notations.
     */

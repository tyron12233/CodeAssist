...
import com.tyron.builder.api.internal.plugins.UnixStartScriptGenerator;
import com.tyron.builder.api.internal.plugins.WindowsStartScriptGenerator;
 ...
 *   mainClass = 'com.tyron.builder.test.Main'
 ...
 * </pre>
 * <p>
 * The default generators are of the type {@link com.tyron.builder.jvm.application.scripts.TemplateBasedScriptGenerator}, with default templates.
 * This templates can be changed via the {@link com.tyron.builder.jvm.application.scripts.TemplateBasedScriptGenerator#setTemplate(com.tyron.builder.api.resources.TextResource)} method.
 * <p>
...
public class CreateStartScripts extends ConventionTask {
     ...
     * <p>
     * Defaults to an implementation of {@link com.tyron.builder.jvm.application.scripts.TemplateBasedScriptGenerator}.
     */
    @Internal
    ...
    protected Iterable<String> getRelativeClasspath() {
        //a list instance is needed here, as com.tyron.builder.internal.snapshot.ValueSnapshotter.processValue() does not support

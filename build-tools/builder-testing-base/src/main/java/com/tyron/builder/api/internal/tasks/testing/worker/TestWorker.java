...
package com.tyron.builder.api.internal.tasks.testing.worker;
...
import com.tyron.builder.internal.actor.internal.DefaultActorFactory;
...
import com.tyron.builder.internal.dispatch.ContextClassLoaderProxy;
...
public class TestWorker implements Action<WorkerProcessContext>, RemoteTestClassProcessor, Serializable, Stoppable {
    ...
    public static final String WORKER_ID_SYS_PROPERTY = "com.tyron.builder.test.worker";
    public static final String WORKER_TMPDIR_SYS_PROPERTY = "com.tyron.builder.internal.worker.tmpdir";

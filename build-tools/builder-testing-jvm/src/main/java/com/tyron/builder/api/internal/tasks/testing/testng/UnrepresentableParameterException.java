...
public class UnrepresentableParameterException extends BuildException {
    ...
    public UnrepresentableParameterException(ITestResult iTestResult,
                                             ...
                                             Throwable cause) {
        super(String
                .format("Parameter %s of iteration %s of method '%s' toString() method threw " +
                        "exception",
                        paramIndex + 1, iTestResult.getMethod().getCurrentInvocationCount() + 1,
                        iTestResult.getName()), cause);
    }
}

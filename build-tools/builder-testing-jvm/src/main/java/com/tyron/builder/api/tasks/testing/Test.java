...
public class Test extends AbstractTestTask implements JavaForkOptions, PatternFilterable {
     ...
     */
    @Override
    public Test include(Predicate<FileTreeElement> includeSpec) {
...
//
     ...
     */
    @Override
    public Test exclude(Predicate<FileTreeElement> excludeSpec) {
...
//        }
    ...
    private <T extends TestFrameworkOptions> TestFramework useTestFramework(TestFramework testFramework, @Nullable Action<T> testFrameworkConfigure) {
        if (optionsAccessed) {
     ...
     * @since 3.5
     */
    public void useJUnit(Action<? extends JUnitOptions> testFrameworkConfigure) {
     ...
     * @since 4.6
     */
    public void useJUnitPlatform(Action<? extends JUnitPlatformOptions> testFrameworkConfigure) {
     ...
     * @since 3.5
     */
    public void useTestNG(Action<? extends TestNGOptions> testFrameworkConfigure) {

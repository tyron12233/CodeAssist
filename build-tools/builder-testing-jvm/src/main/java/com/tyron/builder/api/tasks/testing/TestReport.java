...
import com.tyron.builder.api.internal.tasks.testing.junit.result.AggregateTestResultsProvider;
import com.tyron.builder.api.internal.tasks.testing.junit.result.BinaryResultBackedTestResultsProvider;
...
import static com.tyron.builder.internal.concurrent.CompositeStoppable.stoppable;
...
public class TestReport extends DefaultTask {
     ...
     *
     * <li>Anything that can be converted to a set of {@link File} instances as per {@link com.tyron.builder.api.Project#files(Object...)}. These must

...
import com.tyron.builder.tooling.UnknownModelException;
...
public interface BuildController {
     ...
     *     <li>{@link com.tyron.builder.tooling.model.build.BuildEnvironment}</li>
     *     <li>{@link com.tyron.builder.tooling.model.GradleProject}</li>
     *     <li>{@link com.tyron.builder.tooling.model.gradle.BuildInvocations}</li>
     *     <li>{@link com.tyron.builder.tooling.model.gradle.ProjectPublications}</li>
     *     <li>{@link com.tyron.builder.tooling.model.idea.IdeaProject}</li>
     *     <li>{@link com.tyron.builder.tooling.model.idea.BasicIdeaProject}</li>
     *     <li>{@link com.tyron.builder.tooling.model.eclipse.EclipseProject}</li>
     *     <li>{@link com.tyron.builder.tooling.model.eclipse.HierarchicalEclipseProject}</li>
     * </ul>
     *
     ...
     *
     * <ul>
     *     <li>Any {@link com.tyron.builder.tooling.model.gradle.BasicGradleProject}</li>
     *     <li>Any {@link com.tyron.builder.tooling.model.GradleProject}</li>
     *     <li>Any {@link com.tyron.builder.tooling.model.eclipse.EclipseProject}</li>
     *     <li>Any {@link com.tyron.builder.tooling.model.idea.IdeaModule}</li>
     * </ul>
     *

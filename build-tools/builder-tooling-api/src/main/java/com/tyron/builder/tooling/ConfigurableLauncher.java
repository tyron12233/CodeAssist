...
public interface ConfigurableLauncher<T extends ConfigurableLauncher<T>> extends LongRunningOperation {
     ...
     */
    @Override
    T addProgressListener(com.tyron.builder.tooling.events.ProgressListener listener);
     ...
     */
    @Override
    T addProgressListener(com.tyron.builder.tooling.events.ProgressListener listener, Set<OperationType> eventTypes);
     ...
     */
    @Override
    T addProgressListener(com.tyron.builder.tooling.events.ProgressListener listener, OperationType... operationTypes);

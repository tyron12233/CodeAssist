...
import com.tyron.builder.tooling.internal.consumer.ConnectorServices;
...
public abstract class GradleConnector {
    ...
    /**
     * Creates a new {@link CancellationTokenSource} that can be used to cancel one or more {@link com.tyron.builder.tooling.LongRunningOperation} executions.
     *

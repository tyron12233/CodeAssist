...
public interface LongRunningOperation {
     ...
     * <p>
     * {@link com.tyron.builder.tooling.model.build.BuildEnvironment} model contains information such as Java or Gradle environment.
     ...
     * They are modelled in the Gradle API via {@link com.tyron.builder.StartParameter}.
     ...
     * <p>
     * If an unknown or unsupported command line option is specified, {@link com.tyron.builder.tooling.exceptions.UnsupportedBuildArgumentException}
     ...
     * {@link com.tyron.builder.StartParameter} are supported.
     * <p>
     ...
     *
     * <p>This method is intended to be replaced by {@link #addProgressListener(com.tyron.builder.tooling.events.ProgressListener)}. The new progress listener type
     ...
     */
    @SuppressWarnings("overloads")
    LongRunningOperation addProgressListener(com.tyron.builder.tooling.events.ProgressListener listener);
     ...
     * @since 2.5
     */
    LongRunningOperation addProgressListener(com.tyron.builder.tooling.events.ProgressListener listener, Set<OperationType> operationTypes);
     ...
     * @since 2.6
     */
    LongRunningOperation addProgressListener(com.tyron.builder.tooling.events.ProgressListener listener, OperationType... operationTypes);

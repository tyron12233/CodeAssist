...
import com.tyron.builder.tooling.BuildException;
import com.tyron.builder.tooling.ConfigurableLauncher;
 ...
 *
 * <ul>
 * <li>Create an instance of {@code ModelBuilder} by calling {@link com.tyron.builder.tooling.ProjectConnection#model(Class)}.
...
public interface ModelBuilder<T> extends ConfigurableLauncher<ModelBuilder<T>> {
     ...
     * @throws com.tyron.builder.tooling.exceptions.UnsupportedOperationConfigurationException
     *          When the target Gradle version does not support some requested configuration option such as {@link #withArguments(String...)}.
     * @throws com.tyron.builder.tooling.exceptions.UnsupportedBuildArgumentException When there is a problem with build arguments provided by {@link #withArguments(String...)}.

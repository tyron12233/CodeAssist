...
/**
 * <p>Represents a long-lived connection to a Gradle project. You obtain an instance of a {@code ProjectConnection} by using {@link com.tyron.builder.tooling.GradleConnector#connect()}.</p>
 *
...
public interface ProjectConnection extends Closeable {
     ...
     *
     * <ul>
     *     <li>{@link com.tyron.builder.tooling.model.gradle.GradleBuild}</li>

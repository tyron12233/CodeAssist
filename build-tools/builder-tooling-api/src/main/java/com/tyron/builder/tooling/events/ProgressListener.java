 ...
 *
 * @see com.tyron.builder.tooling.LongRunningOperation#addProgressListener(ProgressListener)
...
public interface ProgressListener {
     ...
     * by querying the descriptor using {@link com.tyron.builder.tooling.events.ProgressEvent#getDescriptor()}.
     * </p>
     *
     * @param event An event describing the operation progress.
     * @see com.tyron.builder.tooling.events.ProgressEvent
     * @see OperationType
     */

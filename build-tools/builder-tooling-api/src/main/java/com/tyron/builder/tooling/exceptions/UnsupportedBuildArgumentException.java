...
/**
 * Thrown when the {@link com.tyron.builder.tooling.LongRunningOperation} has been configured
 * with unsupported build arguments. For more information see the
 * {@link com.tyron.builder.tooling.LongRunningOperation#withArguments(String...)} method.
 */

...
package com.tyron.builder.tooling.exceptions;

import com.tyron.builder.tooling.UnsupportedVersionException;

/**
 * Thrown when a {@link com.tyron.builder.tooling.LongRunningOperation} has been configured
 * with unsupported settings. For example {@link com.tyron.builder.tooling.LongRunningOperation#setJavaHome(java.io.File)}

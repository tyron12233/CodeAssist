...
public class BuildControllerWithoutParameterSupport extends UnparameterizedBuildController {
    private final com.tyron.builder.tooling.internal.protocol.InternalBuildController buildController;
    private final VersionDetails gradleVersion;

    public BuildControllerWithoutParameterSupport(com.tyron.builder.tooling.internal.protocol.InternalBuildController buildController, ProtocolToModelAdapter adapter, ModelMapping modelMapping, File rootDir, VersionDetails gradleVersion) {

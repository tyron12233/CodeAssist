...
import com.tyron.builder.tooling.internal.consumer.connection.AbstractPost12ConsumerConnection;
import com.tyron.builder.tooling.internal.consumer.connection.CancellableModelBuilderBackedModelProducer;
import com.tyron.builder.tooling.internal.consumer.connection.CancellationExceptionTransformer;
import com.tyron.builder.tooling.internal.consumer.connection.PluginClasspathInjectionSupportedCheckModelProducer;
...
public class CancellableConsumerConnection extends AbstractPost12ConsumerConnection {
    ...
    public CancellableConsumerConnection(ConnectionVersion4 delegate, ModelMapping modelMapping, ProtocolToModelAdapter adapter) {
        ...
        Transformer<RuntimeException, RuntimeException> exceptionTransformer =
                CancellationExceptionTransformer
                .transformerFor(getVersionDetails());

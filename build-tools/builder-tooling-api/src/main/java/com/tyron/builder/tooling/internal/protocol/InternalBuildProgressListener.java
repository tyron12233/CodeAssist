...
public interface InternalBuildProgressListener {
     ...
     *
     * <ul>
     *     <li>{@link com.tyron.builder.tooling.internal.protocol.events.InternalTestProgressEvent}</li>
     * </ul>
     *
     * The event types implemented in Gradle 2.5 are:
     *
     * <ul>
     *     <li>{@link com.tyron.builder.tooling.internal.protocol.events.InternalProgressEvent} - used for all operation types.</li>
     *     <li>{@link com.tyron.builder.tooling.internal.protocol.events.InternalTestProgressEvent} - test events also implement these types for backwards compatibility</li>
     * </ul>
     *

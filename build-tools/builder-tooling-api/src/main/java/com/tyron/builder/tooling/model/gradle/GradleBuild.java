...
import com.tyron.builder.tooling.model.BuildModel;
...
public interface GradleBuild extends Model, BuildModel {
    ...
    /**
     * Returns the included builds that were referenced by this build. This is the set of builds that were directly included by this build via its {@link com.tyron.builder.api.initialization.Settings} instance.
     *

...
public final class KotlinDslModelsParameters {
    ...
    public static final String CORRELATION_ID_GRADLE_PROPERTY_NAME = "com.tyron.builder.kotlin.dsl.provider.cid";

    public static final String PROVIDER_MODE_SYSTEM_PROPERTY_NAME = "com.tyron.builder.kotlin.dsl.provider.mode";

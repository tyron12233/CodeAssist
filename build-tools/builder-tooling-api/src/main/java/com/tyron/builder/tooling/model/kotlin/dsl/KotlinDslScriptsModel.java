...
package com.tyron.builder.tooling.model.kotlin.dsl;

import com.tyron.builder.tooling.model.kotlin.dsl.KotlinDslModelsParameters;
 ...
 *
 * The set of scripts can be provided as a Gradle property named <code>com.tyron.builder.kotlin.dsl.provider.scripts</code>,
 ...
 * This is done by providing the system property <code>-Dcom.tyron.builder.kotlin.dsl.provider.mode=classpath</code>.
 ...
 * Optionally, it can also be set in a strict mode by providing the system property value <code>-Dcom.tyron.builder.kotlin.dsl.provider.mode=strict-classpath</code>.
 * See {@link KotlinDslModelsParameters#STRICT_CLASSPATH_MODE_SYSTEM_PROPERTY_DECLARATION}.
 *
 * Optionally, an identifier can be provided as a Gradle property named <code>com.tyron.builder.kotlin.dsl.provider.cid</code>,
...
public interface KotlinDslScriptsModel {
     ...
     */
    String SCRIPTS_GRADLE_PROPERTY_NAME = "com.tyron.builder.tooling.model.kotlin.dsl.scripts";

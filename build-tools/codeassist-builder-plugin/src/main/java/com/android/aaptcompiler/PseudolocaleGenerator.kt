...
import com.android.aaptcompiler.proto.SpanNameAccessor
...
data class UnifiedSpan(
  ...
  constructor(span: StringPool.Span): this(SpanNameAccessor.getName(span).value(), span.firstChar, span.lastChar)

...
//    transformManager,
    ...
    override val minSdkVersion: AndroidVersion = variantBuilder.minSdkVersion
    override val targetSdkVersion: AndroidVersion = variantBuilder.targetSdkVersion
...
//    }
    ...
    override fun <T> getExtension(type: Class<T>): T? = TODO()
...
//    }
    ...
    override val resValues: MapProperty<ResValue.Key, ResValue> = TODO()
//    by lazy {
...
//                && dexingType.needsMainDexList
    ...
    override var unitTest = TODO()

    override val pseudoLocalesEnabled: Property<Boolean> = TODO()
...
//    }
    override val manifestPlaceholders: MapProperty<String, String>
        get() = TODO() // manifestPlaceholdersCreationConfig.placeholders
}

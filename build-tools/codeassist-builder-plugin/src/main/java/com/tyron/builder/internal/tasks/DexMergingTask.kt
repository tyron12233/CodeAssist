...
//            it.initializeFromAndroidVariantTask(this)
    ...
    class CreationAction @JvmOverloads constructor(
        ...
        override fun configure(task: DexMergingTask) {
            ...
            task.sharedParams.minSdkVersion.setDisallowChanges(21)
            ...
            task.numberOfBuckets.setDisallowChanges(
                task.project.providers.provider { 1 }
            )
        ...
        private fun getDexDirs(
            ...
            val attributes = getDexingArtifactConfiguration(null).getAttributes()

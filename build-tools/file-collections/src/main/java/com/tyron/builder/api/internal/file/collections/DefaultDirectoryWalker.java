...
public class DefaultDirectoryWalker implements DirectoryWalker {
    ...
    static boolean shouldVisit(FileTreeElement element, Predicate<? super FileTreeElement> spec) {
    ...
    public void walkDir(File rootDir, RelativePath rootPath, FileVisitor visitor, Predicate<? super FileTreeElement> spec, AtomicBoolean stopFlag, boolean postfix) {
        ...
        try {
            ...
            throw new UncheckedIOException(String.format("Could not list contents of directory '%s'.", rootDir), e);
        }
    }
    ...
    private static class PathVisitor implements java.nio.file.FileVisitor<Path> {
        ...
        private final Predicate<? super FileTreeElement> spec;
        ...
        public PathVisitor(Deque<FileVisitDetails> directoryDetailsHolder, Predicate<? super FileTreeElement> spec, boolean postfix, FileVisitor visitor, AtomicBoolean stopFlag, RelativePath rootPath, FileSystem fileSystem) {
        ...
        public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) {
            ...
            if (shouldVisit(details, spec)) {
                if (attrs.isSymbolicLink()) {
                    ...
                    throw new RuntimeException(String.format("Couldn't follow symbolic link '%s'.", file));
                }

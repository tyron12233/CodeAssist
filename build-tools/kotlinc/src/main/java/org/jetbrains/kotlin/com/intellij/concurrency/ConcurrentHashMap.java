...
// IJ specific:
// copied from Doug Lea ConcurrentHashMap (see http://gee.cs.oswego.edu/dl/concurrency-interest/index.html)
// except:
 ...
 */ final class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>,
        HashingStrategy<K> {
    ...
    static class Node<K, V> implements Map.Entry<K, V> {
        ...
        Node(int hash, K key, V val, @NonNull HashingStrategy<? super K> hashingStrategy) {
            this.hash = hash;
            this.key = key;
            this.val = val;
        ...
        public final int hashCode() {
            return hashingStrategy.hashCode(key) ^ val.hashCode();
        }
    ...
    ConcurrentHashMap(@NonNull HashingStrategy<? super K> hashingStrategy) {
    ...
    public V get(Object key) {
        ...
        if ((tab = table) != null &&
            ...
            while ((e = e.next) != null) {
                if (e.hash == h && ((ek = e.key) == key || (ek != null && isEqual((K) key, ek)))) {
                    return e.val;
                }
            }
        }
                    ...
                    if (tabAt(tab, i) == f) {
                        if (fh >= 0) {
                            ...
                            for (Node<K, V> e = f; ; ++binCount) {
                                K ek;
                                if (e.hash == hash &&
                                    ((ek = e.key) == key || (ek != null && isEqual(key, ek)))) {
                                    oldVal = e.val;
                                    if (!onlyIfAbsent) {
                                        e.val = value;
                                    }
        ...
        while (tab != null && i < tab.length) {
            ...
            if (f == null) {
                ...
                synchronized (f) {
                    if (tabAt(tab, i) == f) {
                        Node<K, V> p = (fh >=
                                        0 ? f : (f instanceof TreeBin) ?                ((TreeBin<K, V>) f).first : null);
                        while (p != null) {
                            --delta;
                            p = p.next;
                        }
    ...
    static final class ForwardingNode<K, V> extends Node<K, V> {
        ...
        ForwardingNode(Node<K, V>[] tab, @NonNull HashingStrategy<? super K> hashingStrategy) {
        ...
        Node<K, V> find(int h, Object k) {
            ...
            for (Node<K, V>[] tab = nextTable; ; ) {
                ...
                for (; ; ) {
                    ...
                    if ((eh = e.hash) == h &&
                        ((ek = e.key) == k ||
                         (ek != null && isEqual((K) k, ek, hashingStrategy)))) {
                        return e;
                    }
                    if (eh < 0) {
    ...
    static final class ReservationNode<K, V> extends Node<K, V> {
        ReservationNode(@NonNull HashingStrategy<? super K> hashingStrategy) {
            ...
            if ((sc = sizeCtl) < 0) {
                ...
                try {
                    if ((tab = table) == null || tab.length == 0) {
                        ...
                        @SuppressWarnings("unchecked") Node<K, V>[] nt =
                                (Node<K, V>[]) new Node<?, ?>[n];
                        table = tab = nt;
                        sc = n - (n >>> 2);
                    }
    ...
    private final void tryPresize(int size) {
        int c = (size >= (MAXIMUM_CAPACITY >>> 1)) ? MAXIMUM_CAPACITY : tableSizeFor(size +
                                                                                     (size >>> 1) +
                                                                                     1);
        int sc;
        while ((sc = sizeCtl) >= 0) {
        ...
        for (int i = 0, bound = 0; ; ) {
            ...
            while (advance) {
                ...
                if (--i >= bound || finishing) {
                    ...
                    i = -1;
                    advance = false;
                } else if (TRANSFERINDEX.compareAndSet(this,
                        nextIndex,
                    ...
                    if (tabAt(tab, i) == f) {
                        ...
                        if (fh >= 0) {
                            ...
                            for (Node<K, V> e = t.first; e != null; e = e.next) {
                                int h = e.hash;
                                TreeNode<K, V> p = new TreeNode<K, V>(h,
                                        e.key,
                                        e.val,
                                        null,
                                        null,
                            ...
                            ln = (lc <= UNTREEIFY_THRESHOLD) ? untreeify(lo) : (hc !=
                                                                                0) ?                        new TreeBin<K, V>(
                                    lo,
                                    hashingStrategy) : t;
                            hn = (hc <= UNTREEIFY_THRESHOLD) ? untreeify(hi) : (lc !=
                                                                                0) ?                    new TreeBin<K, V>(
                                    hi,
                                    hashingStrategy) : t;
                            setTabAt(nextTab, i, ln);
                ...
                synchronized (b) {
                    if (tabAt(tab, index) == b) {
                        ...
                        for (Node<K, V> e = b; e != null; e = e.next) {
                            TreeNode<K, V> p = new TreeNode<K, V>(e.hash,
                                    e.key,
                                    e.val,
                                    null,
                                    null,
                ...
                do {
                    ...
                    if ((ph = p.hash) > h) {
                        ...
                        p = pr;
                               ...
                               (pk != null && isEqual((K) k, pk, hashingStrategy))) {
                        return p;
                    } else if (pl == null) {
                        p = pr;
                    } else if (pr == null) {
    ...
    static final class TreeBin<K, V> extends Node<K, V> {
         ...
         */
        TreeBin(TreeNode<K, V> b, @NonNull HashingStrategy<? super K> hashingStrategy) {
                    ...
                    for (Node<K, V> e = first; e != null; ) {
                        ...
                        if (((s = lockState) & (WAITER | WRITER)) != 0) {
                            ...
                            try {
                                ...
                                Thread w;
                                if ((int) LOCKSTATE.getAndAdd(this, -READER) == (READER | WAITER) &&
                                    (w = waiter) != null) {
        ...
        static <K, V> boolean checkInvariants(TreeNode<K, V> t) {
            TreeNode<K, V> tp = t.parent, tl = t.left, tr = t.right, tb = t.prev, tn =
                    (TreeNode<K, V>) t.next;
        ...
        static {
            try {
                LOCKSTATE = MethodHandles.privateLookupIn(TreeBin.class, MethodHandles.lookup())
    ...
    static final class KeyIterator<K, V> extends BaseIterator<K, V> implements Iterator<K>,
                                Enumeration<K> {
    ...
    static final class ValueIterator<K, V> extends BaseIterator<K, V> implements Iterator<V>,
     Enumeration<V> {
        ValueIterator(Node<K, V>[] tab,
                      int size,
                      int index,
                      int limit,
                      ConcurrentHashMap<K, V> map) {
    ...
    static final class MapEntry<K, V> implements Map.Entry<K, V> {
        ...
        public int hashCode() {
            return map.hash(key) ^ val.hashCode();
        }
    ...
    static final class KeySpliterator<K, V> extends Traverser<K, V> implements Spliterator<K> {
        ...
        public KeySpliterator<K, V> trySplit() {
            int i, f, h;
            return (h = ((i = baseIndex) + (f = baseLimit)) >>> 1) <=
                   i ? null : new KeySpliterator<K, V>(tab, baseSize, baseLimit = h, f, est >>>= 1);
        }
    ...
    static final class ValueSpliterator<K, V> extends Traverser<K, V> implements Spliterator<V> {
        ...
        public ValueSpliterator<K, V> trySplit() {
            int i, f, h;
            return (h = ((i = baseIndex) + (f = baseLimit)) >>> 1) <=
                   i ? null : new ValueSpliterator<K, V>(tab,
                    baseSize,
                    baseLimit = h,
                    f,
                    est >>>= 1);
    ...
    static final class EntrySpliterator<K, V> extends Traverser<K, V> implements Spliterator<Map.Entry<K, V>> {
        ...
        public EntrySpliterator<K, V> trySplit() {
            int i, f, h;
            return (h = ((i = baseIndex) + (f = baseLimit)) >>> 1) <=
                   i ? null : new EntrySpliterator<K, V>(tab,
                    baseSize,
                    baseLimit = h,
                    f,
                    est >>>= 1,
    ...
    public void forEach(long parallelismThreshold, BiConsumer<? super K, ? super V> action) {
        ...
        new ForEachMappingTask<K, V>(null,
    ...
    public int reduceToInt(long parallelismThreshold,
        ...
        return new MapReduceMappingsToIntTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public <U> void forEachKey(long parallelismThreshold,
        ...
        new ForEachTransformedKeyTask<K, V, U>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public <U> U searchKeys(long parallelismThreshold,
        ...
        return new SearchKeysTask<K, V, U>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public K reduceKeys(long parallelismThreshold,
        ...
        return new ReduceKeysTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public <U> U reduceKeys(long parallelismThreshold,
        ...
        return new MapReduceKeysTask<K, V, U>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public double reduceKeysToDouble(long parallelismThreshold,
        ...
        return new MapReduceKeysToDoubleTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public long reduceKeysToLong(long parallelismThreshold,
        ...
        return new MapReduceKeysToLongTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public int reduceKeysToInt(long parallelismThreshold,
        ...
        return new MapReduceKeysToIntTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public <U> U searchValues(long parallelismThreshold,
        ...
        return new SearchValuesTask<K, V, U>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public V reduceValues(long parallelismThreshold,
        ...
        return new ReduceValuesTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public <U> U reduceValues(long parallelismThreshold,
        ...
        return new MapReduceValuesTask<K, V, U>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public double reduceValuesToDouble(long parallelismThreshold,
        ...
        return new MapReduceValuesToDoubleTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public long reduceValuesToLong(long parallelismThreshold,
        ...
        return new MapReduceValuesToLongTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public int reduceValuesToInt(long parallelismThreshold,
        ...
        return new MapReduceValuesToIntTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public <U> void forEachEntry(long parallelismThreshold,
        ...
        new ForEachTransformedEntryTask<K, V, U>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public <U> U searchEntries(long parallelismThreshold,
        ...
        return new SearchEntriesTask<K, V, U>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public Map.Entry<K, V> reduceEntries(long parallelismThreshold,
        ...
        return new ReduceEntriesTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public <U> U reduceEntries(long parallelismThreshold,
        ...
        return new MapReduceEntriesTask<K, V, U>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public double reduceEntriesToDouble(long parallelismThreshold,
        ...
        return new MapReduceEntriesToDoubleTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public long reduceEntriesToLong(long parallelismThreshold,
        ...
        return new MapReduceEntriesToLongTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    public int reduceEntriesToInt(long parallelismThreshold,
        ...
        return new MapReduceEntriesToIntTask<K, V>(null,
                batchFor(parallelismThreshold),
                0,
                0,
                table,
    ...
    abstract static class CollectionView<K, V, E> implements Collection<E>, java.io.Serializable {
        ...
        public final <T> T[] toArray(T[] a) {
            ...
            int m = (int) sz;
            T[] r = (a.length >= m) ? a : (T[]) java.lang.reflect.Array.newInstance(a.getClass()
                    .getComponentType(), m);
            int n = r.length;
            int i = 0;
            for (E e : this) {
    ...
    static final class ForEachValueTask<K, V> extends BulkTask<K, V, Void> {
        ...
        ForEachValueTask(BulkTask<K, V, ?> p,
                         int b,
                         int i,
                         int f,
                         Node<K, V>[] t,
    ...
    static final class ForEachEntryTask<K, V> extends BulkTask<K, V, Void> {
        ...
        ForEachEntryTask(BulkTask<K, V, ?> p,
                         int b,
                         int i,
                         int f,
                         Node<K, V>[] t,
    ...
    static final class ForEachMappingTask<K, V> extends BulkTask<K, V, Void> {
        ...
        ForEachMappingTask(BulkTask<K, V, ?> p,
                           int b,
                           int i,
                           int f,
                           Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((action = this.action) != null) {
                for (int i = baseIndex, f, h; batch > 0 &&
                                              (h = ((f = baseLimit) + i) >>> 1) > i; ) {
                    addToPendingCount(1);
                    new ForEachMappingTask<K, V>(this,
                            batch >>>= 1,
                            baseLimit = h,
                            f,
                            tab,
    ...
    static final class ForEachTransformedKeyTask<K, V, U> extends BulkTask<K, V, Void> {
        ...
        ForEachTransformedKeyTask(BulkTask<K, V, ?> p,
                                  int b,
                                  int i,
                                  int f,
                                  Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (action = this.action) != null) {
                for (int i = baseIndex, f, h; batch > 0 &&
                                              (h = ((f = baseLimit) + i) >>> 1) > i; ) {
                    addToPendingCount(1);
                    new ForEachTransformedKeyTask<K, V, U>(this,
                            batch >>>= 1,
                            baseLimit = h,
                            f,
                            tab,
    ...
    static final class ForEachTransformedValueTask<K, V, U> extends BulkTask<K, V, Void> {
        ...
        ForEachTransformedValueTask(BulkTask<K, V, ?> p,
                                    int b,
                                    int i,
                                    int f,
                                    Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (action = this.action) != null) {
                for (int i = baseIndex, f, h; batch > 0 &&
                                              (h = ((f = baseLimit) + i) >>> 1) > i; ) {
                    addToPendingCount(1);
                    new ForEachTransformedValueTask<K, V, U>(this,
                            batch >>>= 1,
                            baseLimit = h,
                            f,
                            tab,
    ...
    static final class ForEachTransformedEntryTask<K, V, U> extends BulkTask<K, V, Void> {
        ...
        ForEachTransformedEntryTask(BulkTask<K, V, ?> p,
                                    int b,
                                    int i,
                                    int f,
                                    Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (action = this.action) != null) {
                for (int i = baseIndex, f, h; batch > 0 &&
                                              (h = ((f = baseLimit) + i) >>> 1) > i; ) {
                    addToPendingCount(1);
                    new ForEachTransformedEntryTask<K, V, U>(this,
                            batch >>>= 1,
                            baseLimit = h,
                            f,
                            tab,
    ...
    static final class ForEachTransformedMappingTask<K, V, U> extends BulkTask<K, V, Void> {
        ...
        ForEachTransformedMappingTask(BulkTask<K, V, ?> p,
                                      int b,
                                      int i,
                                      int f,
                                      Node<K, V>[] t,
    ...
    static final class SearchValuesTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        SearchValuesTask(BulkTask<K, V, ?> p,
                         int b,
                         int i,
                         int f,
                         Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((searchFunction = this.searchFunction) != null && (result = this.result) != null) {
                for (int i = baseIndex, f, h; batch > 0 &&
                    ...
                    addToPendingCount(1);
                    new SearchValuesTask<K, V, U>(this,
                            batch >>>= 1,
                            baseLimit = h,
                            f,
                            tab,
    ...
    static final class SearchEntriesTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        SearchEntriesTask(BulkTask<K, V, ?> p,
                          int b,
                          int i,
                          int f,
                          Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((searchFunction = this.searchFunction) != null && (result = this.result) != null) {
                for (int i = baseIndex, f, h; batch > 0 &&
                    ...
                    addToPendingCount(1);
                    new SearchEntriesTask<K, V, U>(this,
                            batch >>>= 1,
                            baseLimit = h,
                            f,
                            tab,
    ...
    static final class SearchMappingsTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        SearchMappingsTask(BulkTask<K, V, ?> p,
                           int b,
                           int i,
                           int f,
                           Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((searchFunction = this.searchFunction) != null && (result = this.result) != null) {
                for (int i = baseIndex, f, h; batch > 0 &&
                    ...
                    addToPendingCount(1);
                    new SearchMappingsTask<K, V, U>(this,
                            batch >>>= 1,
                            baseLimit = h,
                            f,
                            tab,
        ...
        public final void compute() {
            ...
            if ((reducer = this.reducer) != null) {
                for (int i = baseIndex, f, h; batch > 0 &&
                                              (h = ((f = baseLimit) + i) >>> 1) > i; ) {
                    addToPendingCount(1);
                    (rights = new ReduceKeysTask<K, V>(this,
                            batch >>>= 1,
                            baseLimit = h,
                            f,
                            tab,
    ...
    static final class ReduceValuesTask<K, V> extends BulkTask<K, V, V> {
        ...
        ReduceValuesTask(BulkTask<K, V, ?> p,
                         int b,
                         int i,
                         int f,
                         Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((reducer = this.reducer) != null) {
                for (int i = baseIndex, f, h; batch > 0 &&
                                              (h = ((f = baseLimit) + i) >>> 1) > i; ) {
                    addToPendingCount(1);
                    (rights = new ReduceValuesTask<K, V>(this,
                            batch >>>= 1,
                            baseLimit = h,
                            f,
                            tab,
    ...
    static final class ReduceEntriesTask<K, V> extends BulkTask<K, V, Map.Entry<K, V>> {
        ...
        ReduceEntriesTask(BulkTask<K, V, ?> p,
                          int b,
                          int i,
                          int f,
                          Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((reducer = this.reducer) != null) {
                for (int i = baseIndex, f, h; batch > 0 &&
                                              (h = ((f = baseLimit) + i) >>> 1) > i; ) {
                    addToPendingCount(1);
                    (rights = new ReduceEntriesTask<K, V>(this,
                            batch >>>= 1,
                            baseLimit = h,
                            f,
                            tab,
    ...
    static final class MapReduceKeysTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        MapReduceKeysTask(BulkTask<K, V, ?> p,
                          int b,
                          int i,
                          int f,
                          Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                for (int i = baseIndex, f, h; batch > 0 &&
                                              (h = ((f = baseLimit) + i) >>> 1) > i; ) {
                    addToPendingCount(1);
                    (rights = new MapReduceKeysTask<K, V, U>(this,
                            batch >>>= 1,
                            baseLimit = h,
                            f,
                            tab,
    ...
    static final class MapReduceValuesTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        MapReduceValuesTask(BulkTask<K, V, ?> p,
                            int b,
                            int i,
                            int f,
                            Node<K, V>[] t,
    ...
    static final class MapReduceEntriesTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        MapReduceEntriesTask(BulkTask<K, V, ?> p,
                             int b,
                             int i,
                             int f,
                             Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    MapReduceEntriesTask<K, V, U> t = (MapReduceEntriesTask<K, V, U>) c, s =
                            t.rights;
                    while (s != null) {
                        U tr, sr;
                        if ((sr = s.result) != null) {
    ...
    static final class MapReduceMappingsTask<K, V, U> extends BulkTask<K, V, U> {
        ...
        MapReduceMappingsTask(BulkTask<K, V, ?> p,
                              int b,
                              int i,
                              int f,
                              Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    MapReduceMappingsTask<K, V, U> t = (MapReduceMappingsTask<K, V, U>) c, s =
                            t.rights;
                    while (s != null) {
                        U tr, sr;
                        if ((sr = s.result) != null) {
    ...
    static final class MapReduceKeysToDoubleTask<K, V> extends BulkTask<K, V, Double> {
        ...
        MapReduceKeysToDoubleTask(BulkTask<K, V, ?> p,
                                  int b,
                                  int i,
                                  int f,
                                  Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    MapReduceKeysToDoubleTask<K, V> t = (MapReduceKeysToDoubleTask<K, V>) c, s =
                            t.rights;
                    while (s != null) {
    ...
    static final class MapReduceValuesToDoubleTask<K, V> extends BulkTask<K, V, Double> {
        ...
        MapReduceValuesToDoubleTask(BulkTask<K, V, ?> p,
                                    int b,
                                    int i,
                                    int f,
                                    Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    MapReduceValuesToDoubleTask<K, V> t = (MapReduceValuesToDoubleTask<K, V>) c, s =
                            t.rights;
                    while (s != null) {
                        t.result = reducer.applyAsDouble(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceEntriesToDoubleTask<K, V> extends BulkTask<K, V, Double> {
        ...
        MapReduceEntriesToDoubleTask(BulkTask<K, V, ?> p,
                                     int b,
                                     int i,
                                     int f,
                                     Node<K, V>[] t,
    ...
    static final class MapReduceMappingsToDoubleTask<K, V> extends BulkTask<K, V, Double> {
        ...
        MapReduceMappingsToDoubleTask(BulkTask<K, V, ?> p,
                                      int b,
                                      int i,
                                      int f,
                                      Node<K, V>[] t,
    ...
    static final class MapReduceKeysToLongTask<K, V> extends BulkTask<K, V, Long> {
        ...
        MapReduceKeysToLongTask(BulkTask<K, V, ?> p,
                                int b,
                                int i,
                                int f,
                                Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    MapReduceKeysToLongTask<K, V> t = (MapReduceKeysToLongTask<K, V>) c, s =
                            t.rights;
                    while (s != null) {
    ...
    static final class MapReduceValuesToLongTask<K, V> extends BulkTask<K, V, Long> {
        ...
        MapReduceValuesToLongTask(BulkTask<K, V, ?> p,
                                  int b,
                                  int i,
                                  int f,
                                  Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    MapReduceValuesToLongTask<K, V> t = (MapReduceValuesToLongTask<K, V>) c, s =
                            t.rights;
                    while (s != null) {
                        t.result = reducer.applyAsLong(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceEntriesToLongTask<K, V> extends BulkTask<K, V, Long> {
        ...
        MapReduceEntriesToLongTask(BulkTask<K, V, ?> p,
                                   int b,
                                   int i,
                                   int f,
                                   Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    MapReduceEntriesToLongTask<K, V> t = (MapReduceEntriesToLongTask<K, V>) c, s =
                            t.rights;
                    while (s != null) {
                        t.result = reducer.applyAsLong(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceMappingsToLongTask<K, V> extends BulkTask<K, V, Long> {
        ...
        MapReduceMappingsToLongTask(BulkTask<K, V, ?> p,
                                    int b,
                                    int i,
                                    int f,
                                    Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    MapReduceMappingsToLongTask<K, V> t = (MapReduceMappingsToLongTask<K, V>) c, s =
                            t.rights;
                    while (s != null) {
                        t.result = reducer.applyAsLong(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceKeysToIntTask<K, V> extends BulkTask<K, V, Integer> {
        ...
        MapReduceKeysToIntTask(BulkTask<K, V, ?> p,
                               int b,
                               int i,
                               int f,
                               Node<K, V>[] t,
    ...
    static final class MapReduceValuesToIntTask<K, V> extends BulkTask<K, V, Integer> {
        ...
        MapReduceValuesToIntTask(BulkTask<K, V, ?> p,
                                 int b,
                                 int i,
                                 int f,
                                 Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    MapReduceValuesToIntTask<K, V> t = (MapReduceValuesToIntTask<K, V>) c, s =
                            t.rights;
                    while (s != null) {
                        t.result = reducer.applyAsInt(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceEntriesToIntTask<K, V> extends BulkTask<K, V, Integer> {
        ...
        MapReduceEntriesToIntTask(BulkTask<K, V, ?> p,
                                  int b,
                                  int i,
                                  int f,
                                  Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    MapReduceEntriesToIntTask<K, V> t = (MapReduceEntriesToIntTask<K, V>) c, s =
                            t.rights;
                    while (s != null) {
                        t.result = reducer.applyAsInt(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static final class MapReduceMappingsToIntTask<K, V> extends BulkTask<K, V, Integer> {
        ...
        MapReduceMappingsToIntTask(BulkTask<K, V, ?> p,
                                   int b,
                                   int i,
                                   int f,
                                   Node<K, V>[] t,
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                CountedCompleter<?> c;
                for (c = firstComplete(); c != null; c = c.nextComplete()) {
                    MapReduceMappingsToIntTask<K, V> t = (MapReduceMappingsToIntTask<K, V>) c, s =
                            t.rights;
                    while (s != null) {
                        t.result = reducer.applyAsInt(t.result, s.result);
                        s = t.rights = s.nextRight;
    ...
    static {
        try {
            SIZECTL = MethodHandles.privateLookupIn(ConcurrentHashMap.class, MethodHandles.lookup())
                    .findVarHandle(ConcurrentHashMap.class, "sizeCtl", int.class);

            TRANSFERINDEX =
                    MethodHandles.privateLookupIn(ConcurrentHashMap.class, MethodHandles.lookup())
            ...
            CELLVALUE = MethodHandles.privateLookupIn(CounterCell.class, MethodHandles.lookup())
    ...
    private static <K> boolean isEqual(@NonNull K key1,
                                       K key2,
                                       @NonNull HashingStrategy<? super K> hashingStrategy) {

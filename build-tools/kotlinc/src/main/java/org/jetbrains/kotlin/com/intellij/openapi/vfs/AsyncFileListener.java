...
/**
 * An alternative to {@link BulkFileListener} that allows
...
public interface AsyncFileListener {
   ...
   * {@link VFileCreateEvent}, {@link FileIndexFacade}
...
//  @Contract(pure = true)
  ...
  interface ChangeApplier {
     ...
     * {@link VFilePropertyChangeEvent} may be already outdated, etc.
     */

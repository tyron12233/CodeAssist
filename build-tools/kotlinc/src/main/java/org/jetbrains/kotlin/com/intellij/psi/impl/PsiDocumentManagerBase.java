...
//            return EditorDocumentPriorities.RANGE_MARKER;
    ...
    private static class FileDocumentManagerBase {
        ...
        public static void registerDocument(Document document, VirtualFile vFile) {
            synchronized (lock) {
                document.putUserData(FILE_KEY, vFile);
                document.putUserData(HARD_REF_TO_DOCUMENT_KEY, document);
            }
        }
    }
}
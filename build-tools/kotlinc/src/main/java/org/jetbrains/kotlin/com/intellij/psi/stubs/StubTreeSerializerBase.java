...
abstract class StubTreeSerializerBase<SerializationState> {
  ...
  private final @NonNull StubStringInterner myStubStringInterner;
  ...
  @NonNull
  Stub deserialize(@NonNull InputStream stream) throws IOException, SerializerNotFoundException {
    ...
    @NonNull SerializationState state = readSerializationState(inputStream);
  ...
  void serialize(@NonNull Stub rootStub, @NonNull OutputStream stream) throws IOException {
    ...
    @NonNull SerializationState serializationState = createSerializationState();
  ...
  protected abstract @NonNull SerializationState readSerializationState(@NonNull StubInputStream stream) throws IOException;


  protected abstract @NonNull SerializationState createSerializationState();


  protected abstract void saveSerializationState(@NonNull SerializationState state, @NonNull DataOutputStream stream)
    throws IOException;

  private Stub deserializeRoot(StubInputStream inputStream,
                               FileLocalStringEnumerator storage,
                               @NonNull SerializationState state) throws IOException, SerializerNotFoundException {
  ...
  protected abstract int writeSerializerId(@NonNull ObjectStubSerializer<Stub, Stub> serializer,
                                           @NonNull SerializationState state) throws IOException;

  private void serializeSelf(Stub stub,
                             @NonNull StubOutputStream stream,
                             @NonNull SerializationState state) throws IOException {
  ...
  private @NonNull ObjectStubSerializer<Stub, Stub> writeSerializerId(Stub stub, @NonNull DataOutput stream, @NonNull SerializationState state)
    throws IOException {
  ...
  private void serializeChildren(@NonNull Stub parent,
                                 @NonNull StubOutputStream stream,
                                 @NonNull SerializationState state) throws IOException {
  ...
  private void deserializeStubList(StubBase<?> root,
                                   ...
                                   FileLocalStringEnumerator storage,
                                   @NonNull SerializationState state)
  ...
  protected abstract ObjectStubSerializer<?, Stub> getClassByIdLocal(int serializedId, @Nullable Stub parentStub, @NonNull SerializationState state) throws SerializerNotFoundException;

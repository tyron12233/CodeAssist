...
public abstract class FileBasedIndexExtension<K, V> extends IndexExtension<K, V, FileContent> {
  ...
  @Override
  public abstract @NonNull ID<K, V> getName();
   ...
   */
  public abstract @NonNull FileBasedIndex.InputFilter getInputFilter();
   ...
   */
  public @NonNull Collection<FileType> getFileTypesWithSizeLimitNotApplicable() {

...
public final class ValueContainerImpl<Value> extends UpdatableValueContainer<Value> implements Cloneable{
  ...
  private static @NonNull IntPredicate getPredicateOutOfFileSetObject(@Nullable Object input) {
      if (input == null) {
          return __ -> false;
      }
  ...
  public ValueContainerImpl<Value> clone() {
    try {
      ...
      clone.myPresentInputIds = myPresentInputIds != null
                                ...
                                : null;
      if (myPresentInputIds != null ){
        clone.myPresentInputIds.putAll(myPresentInputIds);
      }
  ...
  @Override
  public void saveTo(final @NonNull DataOutput out,
                     final @NonNull DataExternalizer<? super Value> externalizer) throws IOException {
  ...
  public static void storeFileSet(final @NonNull DataOutput out,
                                  final @NonNull Object fileSetObject) throws IOException {
  ...
  public void readFrom(@NonNull DataInputStream stream,
                       @NonNull DataExternalizer<? extends Value> externalizer,
                       @NonNull ValueContainerInputRemapping remapping) throws IOException {
    ...
    while (stream.available() > 0) {
      ...
      if (valueCount < 0) {
        ...
        @NonNull Object inputIds = remapping.remap(-valueCount);
        ...
        for (int valueIdx = 0; valueIdx < valueCount; valueIdx++) {
          ...
          if (idCountOrSingleValue > 0) {
            @NonNull Object inputIds = remapping.remap(idCountOrSingleValue);
            ...
            ChangeBufferingList
                    changeBufferingList = ensureFileSetCapacityForValue(value, idCountOrSingleValue);
            int prev = 0;

            for (int i = 0; i < idCountOrSingleValue; i++) {
              final int id = DataInputOutputUtil.readINT(stream);
              @NonNull Object inputIds = remapping.remap(prev + id);

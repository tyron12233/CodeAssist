...
import org.jetbrains.kotlin.com.intellij.util.containers.IntObjectLRUMap;
import org.jetbrains.kotlin.com.intellij.util.io.CachingEnumerator;
import org.jetbrains.kotlin.com.intellij.util.io.DataEnumerator;
...
public class PersistentSubIndexerVersionEnumerator<SubIndexerVersion> implements Closeable {
  ...
  public SubIndexerVersion valueOf(int idx) throws IOException {
    ...
    synchronized (this) {
      IntObjectLRUMap.@Nullable MapEntry<Ref<SubIndexerVersion>> cached = myValueOfCache.getEntry(idx);
        if (cached != null) {

...
//          myIndexingTrace.force();
//      }
//      if (myCompositeHashIdEnumerator != null) {
//          myCompositeHashIdEnumerator.force();
//      }
//  }
//
//  @Override
...
//  }
//  private static final org.jetbrains.kotlin.com.intellij.openapi.util.Key<Integer> ourContentHashIdKey = org.jetbrains.kotlin.com.intellij.openapi.util.Key.create("saved.content.hash.id");
//
//
...
//    try {
//        if (myContents.containsMapping(id)) {
//            return false;
//        }

...
public final class FilePageCacheLockFree implements AutoCloseable {
   ...
   * and housekeeping.
   */
  public PagesTable registerStorage(final @NonNull PagedFileStorageLockFree storage) throws IOException {
    checkNotClosed();
  ...
  Future<?> enqueueStoragePagesClosing(final @NonNull PagedFileStorageLockFree storage,
                                       final @NonNull CompletableFuture<Object> finish) {
    checkNotClosed();
  ...
  private static int adjustPageUsefulness(final @NonNull PageImpl page) {
   ...
   */
  boolean tryToReclaimAll(final @NonNull PagesTable pagesTable) {
   ...
   */
  private void unmapPageAndReclaimBuffer(final @NonNull PageImpl pageToReclaim) {
   ...
   */
  private void reclaimPageBuffer(final @NonNull ByteBuffer pageBuffer) {
  ...
  private static @NonNull ByteBuffer entombPageAndGetPageBuffer(final @NonNull PageImpl pageToUnmap) {
  ...
  @NonNull ByteBuffer allocatePageBuffer(final int bufferSize) {
    checkNotClosed();
  ...
  protected static class CloseStorageCommand extends Command {
    ...
    protected CloseStorageCommand(final @NonNull PagedFileStorageLockFree storageToClose,
                                  final @NonNull CompletableFuture<Object> onFinish) {
  ...
  private static class PagesForReclaimCollector {
    ...
    private @NonNull List<PageImpl> pagesForReclaimNonDirty = Collections.emptyList();
    private @NonNull List<PageImpl> pagesForReclaimDirty = Collections.emptyList();
    ...
    private void checkPageGoodForReclaim(final @NonNull PageImpl page) {
    ...
    private void addCandidateForReclaim(final @NonNull PageImpl page) {
      if (page.isDirty()) {

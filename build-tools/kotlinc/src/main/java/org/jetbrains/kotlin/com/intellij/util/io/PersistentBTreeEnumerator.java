...
public class PersistentBTreeEnumerator<Data> extends PersistentEnumeratorBase<Data> {
  ...
  public PersistentBTreeEnumerator(@NonNull Path file, @NonNull KeyDescriptor<Data> dataDescriptor, int initialSize) throws IOException {
    this(file, dataDescriptor, initialSize, null);
  }

  public PersistentBTreeEnumerator(@NonNull Path file,
  ...
  PersistentBTreeEnumerator(@NonNull Path file,
                            @NonNull KeyDescriptor<Data> dataDescriptor,
                            int initialSize,
                            @Nullable StorageLockContext lockContext,
                            int version,
  ...
  @NonNull
  private static Path indexFile(@NonNull Path file) {
  ...
  @Override
  public boolean processAllDataObject(@NonNull final Processor<? super Data> processor, @Nullable final DataFilter filter)
    throws IOException {
  ...
  public @NonNull PersistentEnumeratorStatistics getStatistics() throws IOException {
    lockStorageRead();
    try {
  ...
  private static class RecordBufferHandler extends PersistentEnumeratorBase.RecordBufferHandler<PersistentBTreeEnumerator<?>> {
    ...
    @Override
    int recordWriteOffset(@NonNull PersistentBTreeEnumerator<?> enumerator, byte[] buf) throws IOException {

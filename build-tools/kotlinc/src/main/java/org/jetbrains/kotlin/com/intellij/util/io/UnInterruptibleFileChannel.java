...
public final class UnInterruptibleFileChannel extends FileChannel {
  ...
  public UnInterruptibleFileChannel(@NonNull Path path, OpenOption... openOptions) throws IOException {
  ...
  public UnInterruptibleFileChannel(@NonNull Path path, Set<? extends OpenOption> openOptions) throws IOException {

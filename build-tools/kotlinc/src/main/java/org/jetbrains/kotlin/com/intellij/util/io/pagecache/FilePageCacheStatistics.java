...
public class FilePageCacheStatistics {
  ...
  public String toPrettyString() {
    ...
    return String.format(Locale.ENGLISH,
      ...
      totalBytesRequested.get() * 1e9 / (1024 * 1024) / totalPagesRequestsNs.get(),
      totalPagesReadNs.get() / 1000.0 / totalPagesAllocated.get(),
      totalBytesRead.get() * 1e9 / (1024 * 1024) / totalPagesReadNs.get(),
      totalPagesWriteNs.get() / 1000.0 / totalPagesWritten.get(),
      totalBytesWritten.get() * 1e9 / (1024 * 1024) / totalPagesWriteNs.get(),

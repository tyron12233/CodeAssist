...
import static org.jetbrains.kotlin.com.intellij.util.io.IOUtil.toHexString;
...
public class PageImpl implements Page {
  ...
  private final @NonNull PageToStorageHandle pageToStorageHandle;
  ...
  private PageImpl(final long offsetInFile,
                   final int pageIndex,
                   final int pageSize,
                   final @NonNull PageToStorageHandle pageToStorageHandle) {
    if (offsetInFile < 0) {
   ...
   */
  public void prepareForUse(final @NonNull PageContentLoader contentLoader) throws IOException {
    pageLock.writeLock().lock();
    try {

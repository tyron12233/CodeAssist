...
class ManifestModel {
            ...
            for (int i = 0; i < childNodes.getLength(); i++) {
                ...
                if (subElement.getType() == NodeTypes.ACTION
                    ...
                    Attr nameAttribute = subElement.getXml()
                            .getAttributeNodeNS(SdkConstants.ANDROID_URI, SdkConstants.ATTR_NAME);
    ...
    enum NodeTypes {
        ...
        SCREEN(MergeType.MERGE, new TwoAttributesBasedKeyResolver(
                new AttributeBasedNodeKeyResolver(SdkConstants.ANDROID_URI, "screenSize"),
                new AttributeBasedNodeKeyResolver(SdkConstants.ANDROID_URI, "screenDensity"))),

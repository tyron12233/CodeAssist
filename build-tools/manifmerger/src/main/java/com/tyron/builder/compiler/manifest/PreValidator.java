    ...
    private static void validateManifestAttribute(
        ...
        if (attributeNode == null && fileType != XmlDocument.Type.OVERLAY) {
            manifest.addMessage(mergingReport,
                    fileType == XmlDocument.Type.MAIN ? MergingReport.Record.Severity.ERROR : MergingReport.Record.Severity.WARNING,
                    String.format(
            ...
            switch(attributeOperationTypeEntry.getValue()) {
                ...
                case REMOVE:
                    ...
                    if (attribute.isPresent()) {
                        ...
                        xmlElement.addMessage(mergingReport, MergingReport.Record.Severity.ERROR, String.format(

...
import com.tyron.viewbinding.parser.XMLParser.AttributeContext;
import com.tyron.viewbinding.parser.XMLParser.ElementContext;
...
public class XmlEditor {
    ...
    private static String defaultReplacement(XMLParser.AttributeContext attr) {
        ...
        final boolean isTwoWay = false; //escapedText.startsWith("@={"); todo: implement data binding
        final boolean isOneWay = false; //escapedText.startsWith("@{"); todo: implement data binding

...
import static com.tyron.xml.completion.repository.api.RenderResources.REFERENCE_EMPTY;
import static com.tyron.xml.completion.repository.api.RenderResources.REFERENCE_NULL;
import static com.tyron.xml.completion.repository.api.RenderResources.REFERENCE_UNDEFINED;
...
public class ResourceUrl implements Serializable {
    ...
    @NotNull public final UrlType urlType;
    ...
    public static ResourceUrl create(
            @NotNull ResourceType type, @NotNull String name, boolean framework) {
    ...
    @NotNull
    public static ResourceUrl create(
            @Nullable String namespace, @NotNull ResourceType type, @NotNull String name) {
    ...
    public static ResourceUrl createAttrReference(
            @Nullable String namespace, @NotNull String name) {
     ...
     */
    @Nullable
    public static ResourceUrl parse(@NotNull String url) {
     ...
     */
    @Nullable
    public static ResourceUrl parse(@NotNull String url, boolean defaultToFramework) {
        // Options:
     ...
     */
    @Nullable
    public static ResourceUrl parseAttrReference(@NotNull String input) {
        if (input.isEmpty()) {
            return null;
        }
     ...
     */
    @Nullable
    public static ResourceUrl parseStyleParentReference(@NotNull String input) {
        if (input.isEmpty()) {
            return null;
        }
    ...
    public static boolean isNullOrEmpty(@NotNull String url) {
    ...
    public static boolean isValidName(@NotNull String input, @NotNull ResourceType type) {
    ...
    public ResourceReference resolve(
            @NotNull ResourceNamespace contextNamespace,

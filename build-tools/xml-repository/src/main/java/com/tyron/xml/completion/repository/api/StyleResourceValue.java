...
public interface StyleResourceValue extends ResourceValue {
    ...
    static boolean isDefaultParentStyleName(
            @NotNull String parentStyleName, @NotNull String styleName) {
     ...
     */
    @Nullable
    StyleItemResourceValue getItem(@NotNull ResourceNamespace namespace, @NotNull String name);

    /** Finds the item for the given attr in this style (if it's defined in this style). */
    @Nullable
    StyleItemResourceValue getItem(@NotNull ResourceReference attr);

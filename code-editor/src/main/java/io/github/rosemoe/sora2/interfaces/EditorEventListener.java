 ...
 */
package io.github.rosemoe.sora2.interfaces;
...
public interface EditorEventListener {
    ...
    /**
     * @see io.github.rosemoe.sora2.text.ContentListener#afterDelete(Content, int, int, int, int, CharSequence)
    ...
    /**
     * @see io.github.rosemoe.sora2.text.ContentListener#afterInsert(Content, int, int, int, int, CharSequence)
     * Note:do not change content at this time
     */
    ...
    /**
     * @see io.github.rosemoe.sora2.text.ContentListener#beforeReplace(Content)
     * Note:do not change content at this time
     */

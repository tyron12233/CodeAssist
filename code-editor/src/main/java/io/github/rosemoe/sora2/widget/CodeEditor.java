 ...
 */
package io.github.rosemoe.sora2.widget;
...
import io.github.rosemoe.sora2.annotations.Experimental;
...
import io.github.rosemoe.sora2.graphics.BufferedDrawPoints;
import io.github.rosemoe.sora2.graphics.FontCache;
import io.github.rosemoe.sora2.interfaces.EditorEventListener;
import io.github.rosemoe.sora2.interfaces.EditorLanguage;
import io.github.rosemoe.sora2.interfaces.EditorTextActionPresenter;
import io.github.rosemoe.sora2.interfaces.ExternalRenderer;
import io.github.rosemoe.sora2.interfaces.NewlineHandler;
import io.github.rosemoe.sora2.interfaces.OnLongPressListener;
import io.github.rosemoe.sora2.langs.EmptyLanguage;
import io.github.rosemoe.sora2.text.CharPosition;
import io.github.rosemoe.sora2.text.Content;
import io.github.rosemoe.sora2.text.ContentLine;
import io.github.rosemoe.sora2.text.ContentListener;
import io.github.rosemoe.sora2.text.Cursor;
import io.github.rosemoe.sora2.text.DiagnosticSpanMapUpdater;
import io.github.rosemoe.sora2.text.FormatThread;
import io.github.rosemoe.sora2.text.LineRemoveListener;
import io.github.rosemoe.sora2.text.SpanMapUpdater;
...
import io.github.rosemoe.sora2.util.LongArrayList;
...
public class CodeEditor extends View implements ContentListener, TextAnalyzer.Callback, FormatThread.FormatResultReceiver, LineRemoveListener {
     ...
     */
    protected void drawRowsOld(Canvas canvas, float offset, LongArrayList postDrawLineNumbers, List<CursorPaintAction> postDrawCursor, LongArrayList postDrawCurrentLines, MutableInt requiredFirstLn) {
        final float waveLength = getDpUnit() * 8;
        final float amplitude = getDpUnit() * 2;
        RowIterator rowIterator = mLayout.obtainRowIterator(getFirstVisibleRow());
        List<Span> temporaryEmptySpans = null;
        ...
        // step 1 - draw background of rows
        for (int row = getFirstVisibleRow(); row <= getLastVisibleRow(); row++) {
            Row rowInf = rowIterator.next();
            int line = rowInf.lineIndex;
            int columnCount = mText.getColumnCount(line);
            if (lastPreparedLine != line) {

...
public class TypeArgumentCompletionProvider {
    ...
    private static boolean hasParameters(PsiTypeParameterListOwner paramOwner, PsiElement context) {
        return paramOwner instanceof PsiClass && true;//ConstructorInsertHandler.hasConstructorParameters((PsiClass)paramOwner, context) != ThreeState.NO;
    }
...
//        });
    ...
    public static class TypeArgsLookupElement extends LookupElement {
        ...
        public void handleInsert(@NotNull InsertionContext context) {
            ...
            DocumentUtils.deleteString(context.getDocument(), context.getStartOffset(), listEnd);

...
import com.tyron.psi.ContainerProvider;
...
import org.jetbrains.kotlin.com.intellij.psi.search.GlobalSearchScopeUtil;
...
public class SearchRequestCollector {
    ...
    private static boolean makesSenseToSearch(@NotNull String word, @NotNull SearchScope searchScope) {
        ...
        return !(searchScope == GlobalSearchScope.EMPTY_SCOPE || searchScope == LocalSearchScope.EMPTY) && !StringUtil.isEmpty(word);
    }

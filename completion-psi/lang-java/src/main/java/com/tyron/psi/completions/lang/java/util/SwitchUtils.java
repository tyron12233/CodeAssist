...
//            }
     ...
     * @return a list of switch branches consisting of either {@link PsiSwitchLabelStatementBase} or {}
     */
    @NotNull
...
//        }
    ...
    public static @Nullable @NonNls
    String createPatternCaseText(PsiExpression expression){
        expression = PsiUtil.skipParenthesizedExprDown(expression);
//        if (expression instanceof PsiInstanceOfExpression) {
...
//            return false;
//        }
        return existingCaseValues == null || existingCaseValues.add(null);
    }

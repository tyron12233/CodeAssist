...
import static com.tyron.psi.patterns.PlatformPatterns.psiElement;
...
public abstract class PsiElementPattern<T extends PsiElement, Self extends PsiElementPattern<T, Self>> extends TreeElementPattern<PsiElement, T, Self> {
    ...
    @NotNull
    public Self beforeLeaf( final String ... withText) {
    ...
    @NotNull
    public Self withName(@NonNls final String ... names) {
    ...
    public Self withTextLength(@NotNull final ElementPattern lengthPattern) {
        return with(new PatternConditionPlus<T, Integer>("withTextLength", lengthPattern) {
            @Override
            public boolean processValues(T t, ProcessingContext context, PairProcessor<? super Integer, ? super ProcessingContext> processor) {
                return processor.process(t.getTextLength(), context);
            }
        });
    }

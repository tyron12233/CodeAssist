...
public class DiffConfig {
  ...
  public static final boolean USE_PATIENCE_ALG = false; //SystemProperties.getBooleanProperty(DIFF_DELTA_PATIENCE_ALG_KEY, false);
  public static final boolean USE_GREEDY_MERGE_MAGIC_RESOLVE = false;
  public static final int DELTA_THRESHOLD_SIZE = 20000; //SystemProperties.getIntProperty(DIFF_DELTA_THRESHOLD_SIZE_KEY, 20000);

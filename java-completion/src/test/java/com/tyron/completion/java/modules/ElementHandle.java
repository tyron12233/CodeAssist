...
public class ElementHandle<T extends Element> {
    ...
    private static final Logger log = Logger.getLogger(ElementHandle.class.getSimpleName());
    ...
    public @CheckForNull
    T resolve (@NonNull final CompilationInfo compilationInfo) {
    ...
    private static final WeakSet<ElementHandle<?>> NORMALIZATION_CACHE = new WeakSet<>();

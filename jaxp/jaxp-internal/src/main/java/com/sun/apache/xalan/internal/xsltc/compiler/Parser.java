...
import com.sun.apache.xalan.internal.xsltc.compiler.util.MethodType;
...
import com.sun.apache.xml.internal.serializer.utils.SystemIDResolver;
import java.io.File;
...
// System.out.println("e = " + text + " " + node);
    ...
    public void startElement(String uri, String localname,
        ...
        if (_root == null) {
            if ((_prefixMapping == null) ||
                (_prefixMapping.containsValue(XSLT_URI) == false))
                _rootNamespaceDef = false;
            else

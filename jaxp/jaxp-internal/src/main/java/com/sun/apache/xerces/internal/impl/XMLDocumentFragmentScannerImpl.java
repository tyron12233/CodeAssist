...
import com.sun.apache.xerces.internal.util.XMLAttributesIteratorImpl;
import com.sun.apache.xerces.internal.util.XMLChar;
import com.sun.apache.xerces.internal.util.XMLStringBuffer;
import com.sun.apache.xerces.internal.util.XMLSymbols;
import com.sun.apache.xerces.internal.utils.SecuritySupport;
import com.sun.apache.xerces.internal.utils.XMLLimitAnalyzer;
...
import com.sun.stream.XMLBufferListener;
import com.sun.stream.XMLEntityStorage;
import com.sun.stream.XMLInputFactoryImpl;
    ...
    protected class FragmentContentDriver
        ...
        protected void checkLimit(XMLStringBuffer buffer) {
            if (fLimitAnalyzer.isTracking(fCurrentEntityName)) {
                fLimitAnalyzer.addValue(XMLSecurityManager.Limit.GENERAL_ENTITY_SIZE_LIMIT, fCurrentEntityName, buffer.length);

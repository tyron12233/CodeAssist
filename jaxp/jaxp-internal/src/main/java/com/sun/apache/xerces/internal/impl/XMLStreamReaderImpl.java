...
import com.sun.apache.xerces.internal.util.NamespaceContextWrapper;
...
import com.sun.stream.dtd.nonvalidating.DTDGrammar;
import com.sun.stream.dtd.nonvalidating.XMLNotationDecl;
import com.sun.stream.Entity;
import com.sun.stream.StaxErrorReporter;
...
public class XMLStreamReaderImpl implements javax.xml.stream.XMLStreamReader {
    ...
    */
    ...
    private void switchToXML11Scanner() throws IOException{
        ...
        com.sun.apache.xerces.internal.xni.NamespaceContext oldNamespaceContext = fScanner.fNamespaceContext;

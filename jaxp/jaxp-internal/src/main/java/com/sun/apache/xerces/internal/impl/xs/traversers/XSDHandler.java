...
package com.sun.apache.xerces.internal.impl.xs.traversers;
...
import com.sun.apache.xerces.internal.impl.dv.SchemaDVFactory;
import com.sun.apache.xerces.internal.impl.dv.xs.XSSimpleTypeDecl;
import com.sun.apache.xerces.internal.impl.xs.SchemaGrammar;
import com.sun.apache.xerces.internal.impl.xs.SchemaNamespaceSupport;
import com.sun.apache.xerces.internal.impl.xs.SchemaSymbols;
import com.sun.apache.xerces.internal.impl.xs.XMLSchemaException;
import com.sun.apache.xerces.internal.impl.xs.XMLSchemaLoader;
import com.sun.apache.xerces.internal.impl.xs.XSAttributeDecl;
import com.sun.apache.xerces.internal.impl.xs.XSAttributeGroupDecl;
import com.sun.apache.xerces.internal.impl.xs.XSComplexTypeDecl;
import com.sun.apache.xerces.internal.impl.xs.XSDDescription;
import com.sun.apache.xerces.internal.impl.xs.XSDeclarationPool;
import com.sun.apache.xerces.internal.impl.xs.XSElementDecl;
import com.sun.apache.xerces.internal.impl.xs.XSGrammarBucket;
import com.sun.apache.xerces.internal.impl.xs.XSGroupDecl;
import com.sun.apache.xerces.internal.impl.xs.XSMessageFormatter;
import com.sun.apache.xerces.internal.impl.xs.XSModelGroupImpl;
import com.sun.apache.xerces.internal.impl.xs.XSNotationDecl;
import com.sun.apache.xerces.internal.impl.xs.XSParticleDecl;
import com.sun.apache.xerces.internal.impl.xs.identity.IdentityConstraint;
import com.sun.apache.xerces.internal.impl.xs.opti.ElementImpl;
import com.sun.apache.xerces.internal.impl.xs.opti.SchemaDOMParser;
import com.sun.apache.xerces.internal.impl.xs.opti.SchemaParsingConfig;
import com.sun.apache.xerces.internal.impl.xs.util.SimpleLocator;
import com.sun.apache.xerces.internal.impl.xs.util.XSInputSource;
import com.sun.apache.xerces.internal.parsers.SAXParser;
import com.sun.apache.xerces.internal.parsers.XML11Configuration;
import com.sun.apache.xerces.internal.util.DOMInputSource;
import com.sun.apache.xerces.internal.util.DOMUtil;
import com.sun.apache.xerces.internal.util.DefaultErrorHandler;
import com.sun.apache.xerces.internal.util.ErrorHandlerWrapper;
import com.sun.apache.xerces.internal.util.SAXInputSource;
import com.sun.apache.xerces.internal.util.StAXInputSource;
import com.sun.apache.xerces.internal.util.StAXLocationWrapper;
import com.sun.apache.xerces.internal.util.SymbolHash;
import com.sun.apache.xerces.internal.util.SymbolTable;
import com.sun.apache.xerces.internal.util.XMLSymbols;
import com.sun.apache.xerces.internal.util.URI.MalformedURIException;
...
import com.sun.apache.xerces.internal.xni.grammars.Grammar;
import com.sun.apache.xerces.internal.xni.grammars.XMLGrammarDescription;
import com.sun.apache.xerces.internal.xni.grammars.XMLGrammarPool;
import com.sun.apache.xerces.internal.xni.grammars.XMLSchemaDescription;
import com.sun.apache.xerces.internal.xni.parser.XMLComponentManager;
import com.sun.apache.xerces.internal.xni.parser.XMLConfigurationException;
import com.sun.apache.xerces.internal.xni.parser.XMLEntityResolver;
import com.sun.apache.xerces.internal.xni.parser.XMLErrorHandler;
import com.sun.apache.xerces.internal.xni.parser.XMLInputSource;
import com.sun.apache.xerces.internal.xni.parser.XMLParseException;
import com.sun.apache.xerces.internal.xs.StringList;
import com.sun.apache.xerces.internal.xs.XSAttributeDeclaration;
import com.sun.apache.xerces.internal.xs.XSAttributeGroupDefinition;
import com.sun.apache.xerces.internal.xs.XSAttributeUse;
import com.sun.apache.xerces.internal.xs.XSConstants;
import com.sun.apache.xerces.internal.xs.XSElementDeclaration;
import com.sun.apache.xerces.internal.xs.XSModelGroup;
import com.sun.apache.xerces.internal.xs.XSModelGroupDefinition;
import com.sun.apache.xerces.internal.xs.XSNamedMap;
import com.sun.apache.xerces.internal.xs.XSObject;
import com.sun.apache.xerces.internal.xs.XSObjectList;
import com.sun.apache.xerces.internal.xs.XSParticle;
import com.sun.apache.xerces.internal.xs.XSSimpleTypeDefinition;

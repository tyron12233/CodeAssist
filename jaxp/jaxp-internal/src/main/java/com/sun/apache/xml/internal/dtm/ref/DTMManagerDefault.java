...
import com.sun.apache.xml.internal.dtm.ref.dom2dtm.DOM2DTM;
import com.sun.apache.xml.internal.dtm.ref.dom2dtm.DOM2DTMdefaultNamespaceDeclarationNode;
...
import com.sun.apache.xml.internal.dtm.DTMException;
            ...
            if (haveXercesParser) {
              ...
              try {
                coParser =(IncrementalSAXSource)
                  Class.forName("com.sun.apache.xml.internal.dtm.ref.IncrementalSAXSource_Xerces").newInstance();
              }  catch( Exception ex ) {
                ex.printStackTrace();
                coParser=null;
              }

...
package com.sun.apache.xml.internal.resolver.helpers;
...
public class BootstrapResolver implements EntityResolver, URIResolver {
  ...
  public BootstrapResolver() {
    URL url = this.getClass().getResource("/com/sun/apache/xml/internal/resolver/etc/catalog.dtd");
    if (url != null) {
      publicMap.put(xmlCatalogPubId, url.toString());
      systemMap.put(xmlCatalogSysId, url.toString());
    }

    url = this.getClass().getResource("/com/sun/apache/xml/internal/resolver/etc/catalog.rng");
    if (url != null) {
      uriMap.put(xmlCatalogRNG, url.toString());
    }

    url = this.getClass().getResource("/com/sun/apache/xml/internal/resolver/etc/catalog.xsd");
    if (url != null) {

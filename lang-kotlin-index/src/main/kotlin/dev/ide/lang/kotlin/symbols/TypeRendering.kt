...
object TypeRendering {
    ...
    fun isFunctionType(fqn: String): Boolean {
        ...
        return (tail.startsWith("Function") && tail.removePrefix("Function")
            .toIntOrNull() != null) ||
     ...
     *  check to recognize a suspend lambda slot. */
    fun isSuspendFunctionType(fqn: String): Boolean {
        val tail = fqn.substringAfterLast('.')
        return tail.startsWith("SuspendFunction") && tail.removePrefix("SuspendFunction")
            .toIntOrNull() != null
    }

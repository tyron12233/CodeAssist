...
class KotlinForEachIntrinsicLoweringTest {
    ...
    fun listForEachLowersToTheInlineExtensionIntrinsicShape() {
        val service = KotlinSymbolService(sourceRoots = emptyList(), classpathJars = listOf(stdlibJarPath().toString()))
    ...
    fun userDefinedForEachExtensionIsNotHijacked() {
        ...
        val service = KotlinSymbolService(sourceRoots = listOf(DiskFile(dir)), classpathJars = listOf(stdlibJarPath().toString()))

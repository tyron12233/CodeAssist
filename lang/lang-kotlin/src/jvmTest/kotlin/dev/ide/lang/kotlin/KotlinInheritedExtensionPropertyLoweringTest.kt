...
class KotlinInheritedExtensionPropertyLoweringTest {
    ...
    fun bareExtensionPropertyOnThisResolves() {
        ...
        val service = KotlinSymbolService(listOf(DiskFile(srcDir)), listOf(stdlibJarPath().toString()))
    ...
    fun extensionPropertyGetterSeesItsReceiverAsImplicitThis() {
        ...
        val service = KotlinSymbolService(listOf(DiskFile(srcDir2)), listOf(stdlibJarPath().toString()))

...
class PreviewLoweringDiskCacheTest {
    ...
    private fun lowering(
        ...
        KotlinSymbolService(listOf(DiskFile(dir)), listOf(stdlibJarPath().toString())),
    ...
    fun staleSaltAndEditedDeclarationsMiss() {
        ...
        KotlinPreviewLowering(
            KotlinSymbolService(listOf(DiskFile(dir)), listOf(stdlibJarPath().toString())), diskCache = cache,

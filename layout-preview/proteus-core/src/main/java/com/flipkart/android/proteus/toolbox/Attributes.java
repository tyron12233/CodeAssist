...
public class Attributes {
  ...
  public static class View {
    ...
    public static final String NextFocusDown = "android:nextFocusDown";
  ...
  public static class WebView {
    public static final String Url = "android:url";
    public static final String HTML = "android:html";
  }

  public static class RatingBar {
    public static final String NumStars = "android:numStars";
    public static final String Rating = "android:rating";
    public static final String IsIndicator = "android:isIndicator";
    public static final String StepSize = "android:stepSize";
    public static final String ProgressDrawable = "android:progressDrawable";
    public static final String MinHeight = "android:minHeight";
  }

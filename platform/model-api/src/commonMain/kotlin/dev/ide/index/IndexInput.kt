...
interface IndexInput {
    ...
    /** Source file path for project-source inputs (null for library/SDK units). A string, because
     *  `java.nio.file.Path` cannot be named from common code and a path is a string wherever there is one. */

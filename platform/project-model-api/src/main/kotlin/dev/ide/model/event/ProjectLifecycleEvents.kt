 ...
 * a listener that throws cannot break the switch. Delivery is synchronous, in subscription order, on the
 * thread performing the switch.
 */
object ProjectTopics {
    val LIFECYCLE: Topic<ProjectEventListener> = Topic("ide.project", ProjectEventListener::class.java)
}
